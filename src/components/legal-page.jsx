...
// ⚠️ 由 scripts/esmify.mjs 从 ../../legal-page.jsx 转换而来，之后有人工改动，不要重跑覆盖。
...
// 同上，改成显式传入。
const lgData = (STRINGS) => (STRINGS.legalPage && (STRINGS.legalPage[STRINGS.lang] || STRINGS.legalPage.en)) || {};
...
const LegalTOC = ({ label, sections }) => {
  const LG_IS_ZH = useIsZh();   // 原为模块顶层常量，会导致中英串台
  return (
