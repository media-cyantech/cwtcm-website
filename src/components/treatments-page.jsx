// ⚠️ 由 scripts/esmify.mjs 从 ../../treatments-page.jsx 转换而来，之后有人工改动，不要重跑覆盖。
// 与根目录原文件的差异仅限：ESM 导入导出 + 语言由 useStrings() 注入（原为自由全局 STRINGS）。

import { useState as useStateTX } from 'react';
...
// ============================================================
const TxHero = ({ c }) => {
  const TX_IS_ZH = useIsZh();   // 原为模块顶层常量，会导致中英串台
  return (
...
export { TxIcon, TxHero, TxCard, TxGroup, TxBridge, TxCTA, TreatmentsPage };
