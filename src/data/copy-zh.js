...
export const COPY = {
  ...
  practitioners: {
    eyebrow: "中医师团队",
    h2: "历经数十年沉淀的团队。",
    sub: "团队 30+ 位 BC 省注册医师，包括从医 50+ 年的资深名医、浮针专家，以及毕业于北京、广州、辽宁、成都、香港和温哥华各中医院校的医师们。",
    cards: [
      {
      ...
      },
      {
        ...
        badge: "白石创办人",
        creds: ["R.TCM.P."],
        subtitle: "加拿大浮针医学会（FSNAC）会长 · 昆特兰理工大学针灸讲师",
        clinic: "白石",
      },
      {
        ...
        crop: "50% 25%",
        name: "Shirley Zhu",
        creds: ["R.TCM.P", "R.Ac", "北美注册芳疗师"],
        subtitle: "出身中医世家 · 曾任职北京国际SOS诊所",
        clinic: "温哥华",
      },
      {
      ...
      },
      {
        ...
        name: "Jake Bai",
        badge: "36 年",
        creds: ["R.TCM.P", "R.Ac", "资深中医师"],
        subtitle: "北京中医药大学针推系硕士 · 临床 36 年 · 术后综合征 / 痛症 / 老年病",
        clinic: "列治文",
      },
      {
        ...
        name: "Jim Yi",
        badge: "30+ 年",
        creds: ["R.TCM.P", "R.Ac", "中医骨伤"],
        subtitle: "中医骨伤科硕士 · 正骨 · 颈肩腰腿与脊柱调理",
        clinic: "温哥华",
      },
      {
        ...
        name: "Wingho Chan",
        creds: ["R.TCM.P"],
        subtitle: "香港大学中医硕士 · 针药并用 · 内妇外科 / 慢性病 / 正骨",
        clinic: "本拿比",
      },
    ],
  },
    ...
    cols: [
      {
        h3: "治养结合",
        sub: "",
        body: "缓解症状只是起点，而非终点。每一套方案同时调理睡眠、消化与体质，让改善在离开诊所之后依然延续。",
      },
      {
        h3: "古法传承，现代标准。",
        sub: "",
        body: "五行辨证、一次性针具、BC 省注册医师、清洁床品。智慧古老，标准与时俱进。",
      },
      {
        h3: "一人一方，因人施治。",
        sub: "",
        body: "没有两次完全相同的方案。脉象、舌诊、体态与病史，决定你当天接受的诊疗。",
      },
    ],
  },
  treatments: {
  ...
  conditions: {
    ...
    // 之后，这句会自动消失，不需要改代码。
    noPageNote: "详情页即将上线 · 欢迎来电了解",
    cards: [
      { slug: "pain-injury", icon: "pain", title: "疼痛与损伤", body: "急慢性疼痛、车祸后康复。" },
      // ⚠️ 不要写「直接结算」——交接文档列为医疗红线（说法未经诊所确认）。
      { slug: "icbc-recovery", icon: "icbc", title: "ICBC 车祸康复", body: "车祸后挥鞭伤与软组织损伤的调理。" },
      { slug: "sleep-stress", icon: "sleep", title: "睡眠与压力", body: "重建神经系统的节律。" },
      { slug: "digestion", icon: "digestion", title: "消化调理", body: "腹胀、肠易激样症状与慢性不适。" },
      { slug: "womens-health", icon: "womens", title: "妇科健康", body: "月经、围绝经期与产后调理。" },
      { slug: "fertility-pregnancy", icon: "fertility", title: "备孕与孕产", body: "从备孕到各孕期的支持。" },
      { slug: "skin-acne", icon: "skin", title: "皮肤与痤疮", body: "超越表面护理的整体调理。" },
      { slug: "headaches-migraines", icon: "headache", title: "头痛与偏头痛", body: "辨证诊断与预防。" },
      // 这两项没有详情页（不在 STRINGS.conditions.live 里），卡片照常展示但不带链接
      { icon: "sports", title: "运动表现", body: "恢复、灵活度与肌腱养护。" },
      { icon: "aging", title: "健康抗衰", body: "精力、专注与延年方案。" },
    ],
  },
  locations: {
    eyebrow: "我们的诊所",
    h2: "四家诊所均提供最高标准医疗品质。",
    cards: [
      { city: "列治文",   caption: "Cooney Road 旗舰店",                              address: "5611 Cooney Rd #130, Richmond, BC V6X 3J6", hours: "周一至周日  10:00–18:30", phone: "(604) 285-5778" },
      { city: "本拿比",   caption: "Kingsway 沿线诊所",                                address: "5665 Kingsway #125, Burnaby, BC V5H 2G4",     hours: "周一至周日  10:00–18:30", phone: "(604) 423-9633" },
      { city: "温哥华",   caption: "West Broadway · Kitsilano",                       address: "3652 West Broadway, Vancouver, BC V6R 2B7",   hours: "周一至周日  10:00–18:30", phone: "(778) 323-6356" },
      { city: "白石",     caption: "Johnston Road 海湾畔 · 浮针特色", address: "1549 Johnston Rd, White Rock, BC V4B 3Z6",
  ...
  heritage: {
    eyebrow: "传承",
    h2: "比我们行医的国度更古老的医学。",
    body: "中医历经两千余年的锤炼。我们的医师在北京、广州、辽宁、成都与香港受训，又选择在卑诗省安家立业。于是这里的诊疗，血脉上无疑是中国的，标准上无疑是加拿大的——一次性针具、注册医师、获 ICBC 认可，并遵循太平洋此岸任何诊所同等的卫生与知情同意标准。我们视自己为这一传统的安静守护者：不事张扬，只是日复一日，在四个社区把它做好。",
  },
  testimonials: {
    eyebrow: "患者亲述",
    h2: "平实的疗效，患者亲口讲述。",
    empty: "我们正在征集患者的真实评价（经本人同意后展示），敬请期待。",
    reviews: [],
  },
  journal: {
    eyebrow: "资讯",
    h2: "来自诊所的札记。",
    cards: [
      { tag: "中医入门", title: "解读脉象：二十八脉究竟在告诉我们什么", excerpt: "在我们的临证中，脉象并非一个频率，而是一套语汇。浮、沉、滑、弦——二十八种脉象，合在一起，描绘的是一份内在的「天气预报」；这份预报，我们要用数年的细致聆听去读懂。", read: "阅读 8 分钟" },
      { tag: "调理方向", title: "ICBC 与针灸：一份说人话的指南", excerpt: "若您因车祸有软组织索赔，ICBC 认可注册针灸治疗。这里逐条说明流程、所需材料，以及为什么多数索赔比想象中简单。", read: "阅读 6 分钟" },
      { tag: "起居养生", title: "借自两千年本草智慧的睡前仪式", excerpt: "睡前一小时，身体所需要的是温煦，而非提振。一小盏红枣茶、一次足浴、灯火渐暗。三个源自本草传统、又能恰好融入温哥华夜晚的小仪式。", read: "阅读 5 分钟" },
    ],
  },
...
// ============================================================
// ABOUT — brand story page (About-ZH.html)
// ============================================================
COPY.about = {
  zh: {
    seoTitle: '关于我们 — 大温四家诊所的传承中医 | 加西中医',
    seoDescription: '大温四家诊所的综合性中医诊疗——传承自中医正脉，恪守加拿大标准。医师在北京、广州、辽宁、成都与香港受训，在卑诗省注册执业。',
    hero: {
      eyebrow: '关于我们',
      h1: '传承医学，用心如一。',
      lede: '大温四家诊所的综合性中医诊疗——传承自中医正脉，恪守加拿大标准。',
      primary: '预约到访',
      primaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
    },
    heritage: {
      eyebrow: '传承',
      body: '中医历经两千余年锤炼。我们的医师在北京、广州、辽宁、成都与香港受训，而后选择在卑诗省安身立业。于是有了这样的照护——血脉里分明是中医，标准上分明是加拿大：一次性针具、注册医师、获 ICBC 认可，并恪守与太平洋这一侧任何诊所同样的卫生与知情同意标准。我们视自己为这一传统的安静守护者：不事张扬，只是日复一日，在四个社区，把它做好。',
      placeholderCaption: '图片即将上线',
    },
    practice: {
      eyebrow: '我们的理念',
      h2: '塑造每一次诊疗的三条信念。',
      principles: [
        {
          ...
          h3: '治养结合',
          zh: '',
          body: '缓解是起点，而非终点。每一套方案都兼顾睡眠、消化与体质，让改善在诊室之外延续。',
        },
        {
          kind: 'standards',
          h3: '传承之法，现代之准',
          zh: '',
          body: '五行辨证、一次性针具、卑诗省注册医师与洁净床品。智慧古老，标准与时俱进。',
        },
        {
          kind: 'individual',
          h3: '一人一方',
          zh: '',
          body: '没有两次完全相同的方案。你的脉象、舌象、体态与病史，决定你当天所受的诊疗。',
        },
      ],
    },
    numbers: {
    ...
    team: {
      eyebrow: '中医师团队',
      line: '历经数十年沉淀的团队。',
      body: '我们 30+ 位中医师中，有从业五十年的资深医师、创办全加首家浮针示范诊所的浮针专家，以及毕业于北京、广州、辽宁、成都各中医院校的医师。',
      link: '浏览全部医师 →',
      href: 'Practitioners-ZH.html',
    },
    clinics: {
      eyebrow: '我们的诊所',
      h2: '四家诊所均提供最高标准医疗品质。',
      cards: [
        { city: '列治文',   line: '旗舰店，位于 Cooney Road。',     href: 'Locations-Richmond-ZH.html' },
        { city: '本拿比',   line: '位于 Kingsway 沿线。',           href: 'Locations-Burnaby-ZH.html' },
        { city: '温哥华',   line: 'Kitsilano 西百老汇街上。',       href: 'Locations-Vancouver-ZH.html' },
        { city: '白石',     line: '海滨码头旁，Johnston Road。',    href: 'Locations-WhiteRock-ZH.html', badge: '全加首家浮针诊所' },
      ],
      viewAll: '查看全部诊所 →',
      viewAllHref: 'Locations-ZH.html',
      cardCta: '进入诊所 →',
    },
    cta: {
      headline: '关怀，此刻与你同在。',
      sub: '大温四家诊所，选择离你最近的一家。',
      primary: '预约到访',
      primaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      secondary: '查找最近的诊所 →',
      secondaryHref: 'Locations-ZH.html',
      ribbon: '选择最近的诊所 →',
      ribbonHref: 'Locations-ZH.html',
    },
  },
};
...
export const STRINGS = {
  ...
  selfLang: { label: '中文' },
  nav: {
    items: ['诊疗项目', '调理方向', '治疗师', '门店', '关于', '资讯'],
    cta: '立即预约',
  },
  // ============================================================
  // TREATMENTS — ZH archive page (Treatments-ZH.html)
  // ============================================================
  treatments: {
    seoTitle: '中医诊疗项目 — 针灸、中药、推拿、浮针 | 加西中医',
    seoDescription: '针灸、推拿、艾灸、拔罐刮痧、正骨、头疗、中药调理、浮针、美容针与注册按摩——传统疗法，现代标准，大温哥华四家诊所。',
    hero: {
      eyebrow: '诊疗项目',
      h1: '历久弥新的中医诊疗。',
      sub: '从针灸、中药到手法理疗——传统方法，现代标准。',
    },
    groups: [
      {
        eyebrow: '传统疗法',
        zh: 'Traditional',
        cards: [
          { slug: 'acupuncture',     name: '针灸',         sub: 'Acupuncture',                tagline: '细针精穴，止痛、安眠、调衡。',                       kind: 'needle'  },
          { slug: 'tui-na',          name: '推拿',         sub: 'Tui Na',                     tagline: '作用于肌肉与经络的中医手法理疗。',                   kind: 'tuina'   },
          { slug: 'moxibustion',     name: '艾灸',         sub: 'Moxibustion',                tagline: '以艾草温热，温通调理。',                              kind: 'moxa'    },
          { slug: 'cupping-gua-sha', name: '拔罐与刮痧',   sub: 'Cupping & Gua Sha',          tagline: '松解紧张、促进循环。',                                kind: 'cupping' },
          { slug: 'manual-bone-setting',    name: '正骨',         sub: 'Manual Bone Setting',        tagline: '针对关节与脊柱的手法正骨。',                          kind: 'boneset' },
          { slug: 'head-therapy',    name: '头疗',         sub: 'Head Therapy',               tagline: '舒缓紧张、助眠提神。',                                kind: 'scalp'   },
          { slug: 'herbal-medicine', name: '中药调理',     sub: 'Herbal Medicine',            tagline: '因人配伍的中药方剂。',                                kind: 'herbs'   },
        ],
      },
      {
        eyebrow: '加西特色',
        ...
        cards: [
          ...
          { slug: 'thread-embedding',        name: '埋线减肥',   sub: 'Acupoint Thread Embedding', tagline: '穴位埋线，持续刺激的减重支持。',        kind: 'needle' },
          { slug: 'xiaoyan-facial',          name: '古法小颜针', sub: 'Xiao Yan Facial Acupuncture',           tagline: '古法针法，松解咬肌、修饰轮廓。',        kind: 'facial' },
          { slug: 'facial-bojin',            name: '面部拨筋',   sub: 'Facial Bo Jin',             tagline: '循经疏拨，疏解紧绷、提亮气色。',            kind: 'tuina'  },
          { slug: 'tcm-acne',                name: '中医暗疮治疗', sub: 'TCM Acne Care',           tagline: '辨证细针与中药的整体暗疮调理。',        kind: 'herbs'  },
        ],
      },
      {
        eyebrow: '临床照护',
        zh: 'Registered & Clinical',
        cards: [
          { slug: 'rmt', name: '注册按摩', sub: 'Registered Massage Therapy (RMT)', tagline: '注册按摩治疗，助力康复与舒缓。', kind: 'rmt' },
          { slug: 'manual-osteopathy', name: '整骨疗法（MOT）', sub: 'Manual Osteopathic Therapy', tagline: '温和的全身手法治疗。', kind: 'boneset' },
          { slug: 'counselling', name: '心理咨询', sub: 'Counselling', tagline: '一对一支持性谈话（温哥华店）。', kind: 'scalp' },
        ],
      },
    ],
    readMore: '了解更多 →',
    bridge: {
      title: '不确定选哪种？从你的不适开始。',
      link: '按调理方向浏览 →',
      href: 'Conditions-ZH.html',
    },
    cta: {
      headline: '关怀，此刻与你同在。',
      sub: '大温四家诊所，随时恭候你的到访。',
    ...
    // data is in place for the next mirror task.
    live: [
    ...
    conditionLabels: {
      'pain-injury':           { name: '疼痛与损伤',         en: 'Pain & Injury' },
      'sleep-stress':          { name: '睡眠与压力',         en: 'Sleep & Stress' },
      'headaches-migraines':   { name: '头痛与偏头痛',       en: 'Headaches & Migraines' },
      'womens-health':         { name: '妇科健康',           en: "Women's Health" },
      'fertility-pregnancy':   { name: '备孕与孕产',         en: 'Fertility & Pregnancy' },
      'digestion':             { name: '消化调理',           en: 'Digestion' },
      'icbc-recovery':         { name: '车祸康复',           en: 'ICBC Recovery' },
      'skin-acne':             { name: '皮肤与痤疮',         en: 'Skin & Acne' },
    ...
    details: {
      acupuncture: {
        ...
        category: '传统疗法',
        kind: 'needle',
        lede: '细针，精穴——一种沉静而历经时间检验的疗法，调理疼痛、睡眠与平衡。',
        seoTitle: '针灸 — 是什么 · 一次诊疗是怎样的 | 加西中医',
        seoDescription: '加西中医的针灸——以极细的一次性针具刺激身体特定穴位，唤起自身的调节反应，调理疼痛、紧张、睡眠与循环。教育性介绍与一次诊疗体验。',
        whatIsIt: [
          '针灸以极细的一次性针具刺激身体特定穴位，唤起自身的调节反应——舒缓肌肉紧张、安抚过度活跃的神经系统、促进局部循环。',
          '它是研究最充分的传统疗法之一，常与常规治疗并用，应对多种疼痛、紧张与睡眠困扰。',
        ],
        whatIsItFootnote: '在中医里，这些穴位分布于经络之上，针灸被视为令『气』重新顺畅运行。',
        whatToExpect: [
          '先经简短问诊（脉、舌、病史），随后下针，留针静养片刻。多数人仅感轻微刺入，随后是沉重或温热感。',
          '针具均为无菌一次性。结束后或感放松、略有倦意。',
        ],
      ...
      'floating-needle': {
        ...
        category: '加西特色',
        kind: 'fsn',
        lede: '现代、近乎无痛的肌肉与肌筋膜疼痛疗法——全加首家专设示范诊所，就在我们的白石店。',
        seoTitle: '浮针（FSN） — 是什么 · 一次诊疗是怎样的 | 加西中医',
        seoDescription: '加西中医的浮针（符氏皮下针法，FSN）——作用于皮下浅层，以柔和的扫散动作替代深刺，针对紧张、疼痛的肌肉与筋膜。白石店为全加首家专设浮针示范诊所。',
        whatIsIt: [
          '浮针（符氏皮下针法，FSN）作用于皮下浅层，以柔和的扫散动作替代深刺。',
          '它针对紧张、疼痛的肌肉与筋膜，以现代、近乎无痛著称，常在当次即见缓解。',
          '我们的白石诊所是全加拿大首家专设浮针示范诊所。是否适用会为每位患者个别评估。',
        ],
        whatIsItFootnote: null,
        whatToExpect: [
          '软针在体表浅层以轻柔扫散运行，同时配合患处活动；多数人感觉近乎无痛。',
          '一次性无菌针具。常以短疗程进行。疗程次数因人而异。',
        ],
        conditions: ['pain-injury', 'icbc-recovery', 'headaches-migraines'],
        related: ['acupuncture', 'tui-na'],
        whiteRockNote: {
          line: '白石店为浮针在线上拥有专属家园。',
          link: '访问白石网站 →',
      ...
      'tui-na': {
        ...
        category: '传统疗法',
        kind: 'tuina',
        lede: '作用于肌肉、关节与经络的中医手法理疗。',
        seoTitle: '推拿 — 中医手法理疗 | 加西中医',
        seoDescription: '加西中医的推拿——中医的手法理疗，以揉、按、推、拉作用于肌肉与关节，松解紧张、缓解僵硬、改善活动度与循环。',
        whatIsIt: [
          '推拿是中医的手法理疗——以揉、按、推、拉作用于肌肉与关节，松解紧张、缓解僵硬、改善活动度与循环。',
          '常用于肌骨疼痛与紧张，可单独进行或与针灸并用。',
        ],
        whatIsItFootnote: '在中医里，这些手法被视为疏通经络气血。',
        whatToExpect: [
          '在着衣或半着衣状态下，沿肌肉与关节施以按压与活动。力度按你的舒适度调整，部分部位或有酸胀。',
          '不用针。',
        ],
      ...
      moxibustion: {
        ...
        kind: 'moxa',
        lede: '以艾草温热的温通疗法。',
        seoTitle: '艾灸 — 温通调理 | 加西中医',
        seoDescription: '加西中医的艾灸——以点燃的艾草在皮肤上方温熏特定穴位或部位，温和透达，缓解寒凉、僵硬或酸痛，促进循环与消化舒适。',
        whatIsIt: [
          '艾灸以点燃的艾草在皮肤上方温熏特定穴位或部位。',
          '温和而透达的热力，用于缓解寒凉、僵硬或酸痛，并促进循环与消化舒适。常与针灸配合。',
        ],
        whatIsItFootnote: '中医视之为温通气血、驱散『寒』象。',
        whatToExpect: [
          '皮肤上方的温热，是舒适的辐射热感，火候由医师全程照看。',
          '或有淡淡艾草烟气与香味。若觉过热，请随时告知医师。',
        ],
      ...
      'fuyang-moxibustion': {
        ...
        category: '加西特色',
        kind: 'moxa',
        lede: '大面积、层层递进的艾火温养，扶助阳气、驱散寒凉。',
        seoTitle: '扶阳灸 — 温阳散寒的深度艾灸 | 加西中医',
        seoDescription: '加西中医的扶阳灸——以持续、层层递进的艾火温养腰腹等较大区域，扶助阳气，改善畏寒怕冷、疲乏与腹部虚寒，温通气血。',
        whatIsIt: [
          '扶阳灸以充足而持续的艾火，温养腰背与腹部等较大区域，而非单一穴位。',
          '中医多用于『阳虚』『虚寒』体质：长期怕冷、疲乏无力、手脚冰凉、腰腹冷痛、脾胃虚弱。许多人觉得温暖舒适、灸后周身松快。',
        ],
        whatIsItFootnote: '中医视之为经由督脉、任脉温补阳气。',
        whatToExpect: [
          '大面积、缓缓累积的辐射热感——温热舒适，火候由医师全程照看。',
          '过程从容、深度放松，伴淡淡艾香。若觉过热，请随时告知医师。',
        ],
        bookHeadline: '扶阳灸 · 列治文、温哥华与白石店提供。',
        bookSub: '在列治文、温哥华（Kitsilano）或白石店预约，选择离你最近的一家。',
      ...
      'fire-dragon-moxibustion': {
        ...
        category: '加西特色',
        kind: 'moxa',
        lede: '沿脊背铺陈的招牌灸法——药草与艾火如火龙般温透整个背部。',
        seoTitle: '火龙灸 — 沿脊温通的招牌灸法 | 加西中医',
        seoDescription: '加西中医本拿比店的火龙灸——沿脊背铺陈药草与艾火，热力深透，常用于寒湿体质、颈腰背僵冷、疲乏与痛经。',
        whatIsIt: [
          '火龙灸沿脊柱铺陈药草与艾绒，如一条温热的『火龙』贯通整个背部。',
          '热力强而舒适、层层深透，中医常用于寒湿体质：颈肩腰背僵冷、畏寒、疲乏与痛经。火龙灸也是诊所中最温暖的灸法之一。',
        ],
        whatIsItFootnote: '中医视之为温通督脉——『阳脉之海』。',
        whatToExpect: [
          '沿背部铺姜、药草与艾绒，热感缓慢、一波波累积。',
          '全程俯卧休息，多数人感觉非常舒缓。灸后皮肤短暂泛红属正常。',
        ],
        bookHeadline: '火龙灸 · 本拿比店特色项目。',
        bookSub: '本拿比 Kingsway 店的招牌灸法，欢迎预约体验。',
      ...
      'thread-embedding': {
        ...
        category: '加西特色',
        kind: 'needle',
        lede: '以可吸收线体埋入穴位、持续温和刺激——配合饮食与运动的减重支持。',
        seoTitle: '埋线减肥 — 穴位埋线减重支持 | 加西中医',
        seoDescription: '加西中医的埋线减肥——以细针把可吸收线体植入选定穴位，在复诊间隔持续温和刺激，配合合理饮食与运动，辅助调节食欲与代谢。效果因人而异。',
        whatIsIt: [
          '以细针把可吸收线体植入选定穴位；线体在数周内自然吸收，期间持续温和刺激穴位——相当于诊后仍在进行的针灸。',
          '中医减重调理中，用于辅助调节食欲、消化与代谢，须配合合理饮食与运动。效果因人而异，医师会先辨证评估。',
        ],
        whatIsItFootnote: '亦称穴位埋线（PDO／羊肠线）；仅使用一次性无菌材料。',
        whatToExpect: [
          '每个穴位埋线时有短促针感；一两天内局部或有轻微酸胀。',
          '线体自行吸收，无需拆除。医师会按你的方案安排疗程间隔。',
        ],
      ...
      'xiaoyan-facial': {
        ...
        category: '加西特色',
        kind: 'facial',
        lede: '古法极细针法，松解咬肌紧张、修饰面部轮廓。',
        seoTitle: '古法小颜针 — 轮廓修饰与咬肌放松 | 加西中医',
        seoDescription: '加西中医的古法小颜针——以极细针依古法作用于面部肌肉与筋膜，松解紧咬导致的咬肌紧张，帮助下颌与面颊轮廓更显紧致。非注射，以疗程进行。',
        whatIsIt: [
          '小颜针以极细的针依古法作用于面部肌肉与筋膜。',
          '常用于放松因紧咬造成的咬肌与下颌紧张，帮助下颌线与面颊轮廓更显紧致。全程仅用针——不含任何注射，通常以疗程进行。',
        ],
        whatIsItFootnote: '效果循序渐进，因人而异。',
        whatToExpect: [
          '沿下颌、面颊与太阳穴布极细针，多数人只有轻微针感。',
          '通常按疗程进行，医师会随你的反应调整方案。',
        ],
      ...
      'facial-bojin': {
        ...
        category: '加西特色',
        kind: 'tuina',
        lede: '以拨筋工具循面部经络疏通——疏解紧绷、畅通循环、提亮气色。',
        seoTitle: '面部拨筋 — 面部经络疏通 | 加西中医',
        seoDescription: '加西中医的面部拨筋——以光滑拨筋工具沿面部经络与筋膜精准疏拨，松解面颊与下颌紧张，促进局部循环与淋巴流动，减轻浮肿观感、提亮气色。',
        whatIsIt: [
          '拨筋以光滑的拨筋工具（传统多为牛角），沿面部经络与筋膜精准疏拨。',
          '用于松解面部与下颌紧张、促进局部循环与淋巴流动、减轻浮肿观感——许多人做完觉得脸部轻盈、气色更好。',
        ],
        whatIsItFootnote: '中医视之为疏通面部经络。',
        whatToExpect: [
          '沿眉骨、面颊与下颌线做有力而舒适的疏拨；因循环加快而短暂泛红属正常。',
          '常与头疗或面部针灸搭配。',
        ],
      ...
      'tcm-acne': {
        ...
        category: '加西特色',
        kind: 'herbs',
        lede: '整体观的暗疮调理——细针、内服中药与辨证的生活指导。',
        seoTitle: '中医暗疮治疗 — 整体调理反复暗疮 | 加西中医',
        seoDescription: '加西中医的中医暗疮治疗——辨证论治，结合面部细针、个性化中药与实用饮食指导，调理反复发作与激素相关的暗疮；与皮肤科照护协同进行。',
        whatIsIt: [
          '不只处理表面——中医暗疮调理从辨证开始：皮肤、消化、月经周期、睡眠与压力一并解读。',
          '方案可结合面部细针、个性化中药与实用的饮食建议，常用于反复发作或与激素相关的暗疮。我们与皮肤科照护协同，而非替代。',
        ],
        whatIsItFootnote: '另见「皮肤与痤疮」调理方向页。',
        whatToExpect: [
          '先做完整问诊；再依辨证选用细针、中药，或两者并用。',
          '皮肤改善是渐进的——以疗程为单位复核进展。',
        ],
        conditions: ['skin-acne'],
      ...
      'manual-osteopathy': {
        ...
        category: '临床照护',
        kind: 'boneset',
        lede: '温和的全身手法治疗——关节、肌肉与筋膜的整体调理。',
        seoTitle: '整骨疗法（MOT） — 温和的全身手法照护 | 加西中医',
        seoDescription: '加西中医的整骨疗法（MOT）——从体态、关节、肌肉、筋膜与循环整体评估，以温和手法松动关节与软组织，改善慢性紧张、体态劳损与活动受限。',
        whatIsIt: [
          '整骨疗法（MOT）以整体视角看待身体——体态、关节、肌肉、筋膜与循环一并评估。',
          '以温和的手法松动关节与软组织，缓解慢性紧张、关节受限与体态劳损，让活动更轻松。与中医推拿、正骨自然互补。',
        ],
        whatIsItFootnote: '与传统正骨不同——MOT 循西方整骨（Osteopathy）原理进行。',
        whatToExpect: [
          '先做体态与活动度评估，再进行从容的手法治疗；请穿着舒适衣物。',
          '手法温和，多数人感觉放松，治疗后周身松快。',
        ],
        bookHeadline: '整骨疗法（MOT）· 欢迎预约。',
        bookSub: '可预约门店请与诊所确认，前台乐意为你安排。',
      ...
      counselling: {
        ...
        category: '临床照护',
        kind: 'scalp',
        lede: '一对一支持性谈话，温哥华店提供，与中医调理相辅相成。',
        seoTitle: '心理咨询 — 一对一支持性谈话 | 加西中医',
        seoDescription: '加西中医温哥华店的心理咨询——保密的一对一谈话，面向压力、情绪低落与人生转折期，提供中英双语，可与针灸、中药相配合。',
        whatIsIt: [
          '保密而支持性的谈话空间——聊聊压力、焦虑、情绪低落或一段难走的路，提供中英双语。',
          '这里的心理咨询与中医照护并行：许多人将谈话与针灸或中药搭配，身心同调。它是医疗与精神科照护的补充，而非替代。',
        ],
        whatIsItFootnote: '如遇危机，请拨打或发短信至 9-8-8（加拿大自杀危机热线），拨打 911，或致电 BC 省心理支援热线 310-6789。',
        whatToExpect: [
          '第一次会谈从容展开——聊聊你的近况与需要的支持。',
          '谈话私密、节奏由你决定；合适时咨询师会建议搭配针灸。',
        ],
        bookHeadline: '心理咨询 · 温哥华店提供。',
        bookSub: '于温哥华（Kitsilano）West Broadway 店提供，欢迎预约。',
      ...
      'cupping-gua-sha': {
        ...
        category: '传统疗法',
        kind: 'cupping',
        lede: '以负压与轻刮松解紧张，引气血上达体表。',
        seoTitle: '拔罐与刮痧 — 行气活血，松解紧张 | 加西中医',
        seoDescription: '加西中医的拔罐与刮痧——以温和负压与轻刮带动局部新鲜循环，常用于肌肉紧张、僵硬及外感初起。',
        whatIsIt: [
          '拔罐以温和负压提起皮肤与浅层组织；刮痧则以光滑器具沿皮肤轻刮。',
          '二者皆引动局部新鲜循环，常用于肌肉紧张、僵硬及外感初起。可能留下数日内自行消退的暂时性痕迹。',
        ],
        whatIsItFootnote: '中医视之为行气活血、化解瘀滞。',
        whatToExpect: [
          '拔罐有牵拉感，刮痧为轻刮感。',
          '暂时性的圆形或泛红痕迹属正常，并非通常意义的瘀伤，数日内消退。',
        ],
      ...
      'manual-bone-setting': {
        ...
        category: '传统疗法',
        kind: 'boneset',
        lede: '针对关节、脊柱与肌骨结构的手法正骨。',
        seoTitle: '正骨 — 手法对位与调整 | 加西中医',
        seoDescription: '加西中医的正骨——以细致的体位与调整缓解关节与脊柱的活动受限，改善结构对位，减轻相关疼痛。',
        whatIsIt: [
          '正骨是一种手法技术，通过细致的体位与调整，缓解关节与脊柱的活动受限、改善结构对位、减轻相关疼痛。',
          '常用于颈、肩、背部不适，多在充分评估后进行，并配合软组织手法。<em>是否适用因人评估。</em>',
        ],
        whatIsItFootnote: null,
        whatToExpect: [
          '先行评估，再施以温和而有针对性的调整。过程中或有松动的声响或感觉。',
          '医师会先确认是否适合你，再进行。',
        ],
      ...
      'head-therapy': {
        ...
        category: '传统疗法',
        kind: 'scalp',
        lede: '头部理疗——舒缓紧张、助眠、提神醒脑。',
        seoTitle: '头疗 — 舒缓紧张、助眠提神 | 加西中医',
        seoDescription: '加西中医的头疗——结合头皮按摩与头颈部穴位手法，舒缓紧张，助益睡眠，化解久对屏幕与压力累积的紧绷。',
        whatIsIt: [
          '头疗结合头皮按摩与头颈部穴位手法，舒缓紧张、助益睡眠，化解久对屏幕与压力累积的紧绷。',
          '是一段令人放松、恢复元气的理疗，许多人会与针灸搭配。',
        ],
        whatIsItFootnote: null,
        whatToExpect: [
          '或坐或卧，于头皮、太阳穴与颈部施以按摩与按压。',
          '深度放松，许多人觉得有助缓解头痛、改善睡眠。',
        ],
        conditions: ['sleep-stress', 'headaches-migraines'],
        related: ['acupuncture', 'tui-na'],
      },
      'aesthetic-acupuncture': {
        ...
        category: '加西特色',
        kind: 'facial',
        lede: '面向面部紧致、焕活与气色的美容针。',
        seoTitle: '美容针 — 面部紧致、焕活、气色 | 加西中医',
        seoDescription: '加西中医的美容针——以极细的针作用于面部，促进局部循环与肌肉张力，令气色更显清新舒展；以疗程进行，效果循序渐进。',
        whatIsIt: [
          '美容针以极细的针作用于面部，促进局部循环与肌肉张力，令气色更显清新、舒展。',
          '手法温和、循序渐进，常以疗程进行，并与我们一贯的整体调理观相承——睡眠、消化与体质都在调理之内。<em>非医美或外科手术，效果因人而异。</em>',
        ],
        whatIsItFootnote: null,
        whatToExpect: [
      ...
      'herbal-medicine': {
        ...
        category: '传统疗法',
        kind: 'herbs',
        lede: '天然草本，辨证施治，个体化配方。',
        seoTitle: '中药调理 — 是什么 · 一次诊疗是怎样的 | 加西中医',
        seoDescription: '加西中医的中药调理——以植物（及矿物）成分配伍而成，在中医辨证后依个人体质开方。常用于调理消化、睡眠、妇科、皮肤与康复。',
        whatIsIt: [
          '在加西中医，每位患者都会由 BC 注册中医师进行详细问诊、望闻问切，根据体质和症状制定专属中药方案。',
        ...
        richSections: [
          ...
          { title: '常见适应症', html: '中医辨证后，可根据个人情况制定中药方案，常见包括：消化系统（胃痛、胃胀、反酸、便秘、腹泻）· 睡眠问题（失眠、多梦）· 妇科调理（月经不调、痛经、更年期调理）· 疼痛管理（颈肩腰腿痛）· 呼吸系统（咳嗽、鼻炎）· 亚健康调理 · 疲劳与压力管理 · 体质调理 · 四季养生。<br/><em>实际治疗方案需由注册中医师根据个人情况评估后制定。</em>' },
          { title: '为什么选择加西中医', html: '✔ BC 注册中医师一对一辨证<br/>✔ 个性化中药处方<br/>✔ 中草药＋科学中药＋中成药三种选择<br/>✔ 中药代煎服务<br/>✔ 配合针灸、艾灸等综合治疗<br/>✔ 多家连锁门诊，服务便捷' },
        ],
        whatToExpect: [
          '经中医辨证后开具方剂（颗粒、饮片或其他形式，各店略有不同），并附煎服与时间说明。',
          '复诊时检视并调整方剂。',
        ],
    ...
    detailChrome: {
      breadcrumbHome: '诊疗项目',
      breadcrumbHomeHref: 'Treatments-ZH.html',
      whatIsItEyebrow: '是什么',
      whatToExpectEyebrow: '一次诊疗是怎样的',
      conditionsEyebrow: '常用于',
      practitionersEyebrow: '提供此疗法的医师',
      practitionersBody: '我们大多数医师都提供此疗法。具体医师对应的明细仍在整理中，欢迎先浏览全体团队。',
      practitionersLink: '了解我们的医师 →',
      practitionersHref: 'Practitioners-ZH.html',
      relatedEyebrow: '相关疗法',
      heroPrimary: '预约到访',
      heroPrimaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      heroSecondary: '查看医师 ↓',
      bookHeadline: (name) => `${name} ${'\u00B7'} 在大温四家诊所，随时为你预约。`,
      bookSub: '从大温哥华四家诊所中，选择离你最近的一家。',
      bookPrimary: '预约到访',
      bookPrimaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      bookSecondary: '查找最近的诊所 →',
      bookSecondaryHref: 'Locations-ZH.html',
    },
  },

  // Stub for the ZH conditions archive — will be filled in the mirror task.
  conditions: {
    seoTitle: '调理方向 — 疼痛、睡眠、消化、妇科等 | 加西中医',
    seoDescription: '加西中医的诊疗范围概览——疼痛与损伤、车祸康复、头痛、睡眠与压力、消化调理、妇科健康、备孕与孕产、皮肤与痤疮。从你的感受出发。',
    live: [
      'pain-injury',
      'icbc-recovery',
      'headaches-migraines',
    ...
    groups: [
      {
        ...
        zh: 'Body & Pain',
        cards: [
          { slug: 'pain-injury',         name: '疼痛与损伤',    sub: 'Pain & Injury',         desc: '颈肩腰背、关节与运动疼痛。',          kind: 'pain' },
          { slug: 'icbc-recovery',       name: '车祸康复',      sub: 'ICBC Recovery',         desc: '车祸后的康复调理。',                kind: 'icbc' },
          { slug: 'headaches-migraines', name: '头痛与偏头痛',  sub: 'Headaches & Migraines', desc: '紧张性头痛与偏头痛。',                   kind: 'headaches' },
        ],
      },
      {
        eyebrow: '内调与养护',
        zh: 'Internal & Wellness',
        cards: [
          { slug: 'sleep-stress', name: '睡眠与压力', sub: 'Sleep & Stress', desc: '失眠、烦躁与身心耗竭。',       kind: 'sleep' },
          { slug: 'digestion',    name: '消化调理',    sub: 'Digestion',      desc: '腹胀、食欲与肠胃舒适。',       kind: 'digestion' },
        ],
      },
      {
        eyebrow: '女性与皮肤',
        zh: 'Women & Skin',
        cards: [
          { slug: 'womens-health',       name: '妇科健康',     sub: "Women's Health",         desc: '月经、更年期与女性调理。',      kind: 'women' },
          { slug: 'fertility-pregnancy', name: '备孕与孕产',   sub: 'Fertility & Pregnancy',  desc: '孕前、孕期与产后的调理支持。', kind: 'fertility' },
          { slug: 'skin-acne',           name: '皮肤与痤疮',   sub: 'Skin & Acne',            desc: '痤疮、暗沉与肌肤平衡。',        kind: 'skin' },
        ],
      },
    ],
    arrow: '→',
    ...
    detailChrome: {
      breadcrumbHome: '调理方向',
      breadcrumbHomeHref: 'Conditions-ZH.html',
      howEyebrow: '中医如何帮助',
      howFootnoteEyebrow: '在中医里',
      treatmentsEyebrow: '我们常用的疗法',
      practitionersEyebrow: '专注此方向的医师',
      practitionersBody: '本方向的医师正在陆续添加。',
      practitionersLink: '浏览全部医师 →',
      practitionersHref: 'Practitioners-ZH.html',
      whatToExpectEyebrow: '你可以预期什么',
      faqEyebrow: '常见问题',
      heroPrimary: '预约到访',
      heroPrimaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      heroSecondary: '了解我们如何帮助 ↓',
      bookHeadline: (name) => `为「${name}」预约到访。`,
      bookSub: '大温哥华四家诊所，选择离你最近的一家。',
      bookPrimary: '预约到访',
      bookPrimaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      bookSecondary: '查找最近的诊所 →',
      bookSecondaryHref: 'Locations-ZH.html',
    ...
    // mirror coming next); strings here so they're ready when they are.
    details: {
      'pain-injury': {
        slug: 'pain-injury',
        ...
        kind: 'pain',
        seoTitle: '疼痛与损伤 与中医调理 | 加西中医',
        seoDescription: '加西中医的疼痛与损伤调理——针灸、推拿、拔罐、正骨、浮针与艾灸，松解肌肉筋膜紧张，安抚疼痛反应，恢复活动度与循环。',
        lede: '颈肩腰背、关节与运动疼痛——以历经时间检验的手法用心调理。',
        howTcm: '日常疼痛多与肌肉筋膜紧张、关节激惹及神经系统的「戒备」状态有关。针灸、推拿、拔罐与正骨常用于松解紧张、安抚疼痛反应、恢复活动度与循环——通常在短疗程内见缓解。我们与你的常规医疗并行，而非取代。',
        howTcmFootnote: '中医视久痛为「不通」，疗法助其通行。',
        treatments: ['acupuncture', 'tui-na', 'cupping-gua-sha', 'manual-bone-setting', 'floating-needle', 'moxibustion'],
        whatToExpect: '初诊会先做评估，再为你制定个性化方案；治疗常多法并用，并在复诊中持续观察、调整。具体频次与疗程因人而异。',
        whatToExpectFootnote: null,
        faqs: [
          {
            q: '会痛吗？',
            a: '多数人感觉轻微、可耐受；过程中我们会随时照顾你的感受。',
          },
          {
            q: '需要做几次？',
            a: '因人而异，通常为一个短疗程。',
      ...
      'icbc-recovery': {
        ...
        category: '身体与疼痛', categoryEn: 'Body & Pain',
        kind: 'icbc',
        seoTitle: '车祸康复 与中医调理 | 加西中医',
        seoDescription: '加西中医的车祸康复——注册针灸与相关疗法常用于缓解颈、背、肩疼痛、僵硬、头痛与睡眠困扰，支持康复与活动恢复。在卑诗省，ICBC 认可注册医师的治疗。',
        lede: '车祸后的康复——为挥鞭样损伤、扭拉伤与僵硬提供调理支持。',
        howTcm: '车祸后，颈、背、肩疼痛、僵硬、头痛与睡眠困扰都很常见。注册针灸及相关疗法常用于缓解疼痛与紧张、支持康复与活动恢复。在卑诗省，ICBC 认可注册医师的治疗——我们可协助你了解流程。<br/><br/><strong>各诊所 ICBC 覆盖</strong><table style="width:100%;border-collapse:collapse;margin-top:12px;font-size:0.92em;"><thead><tr style="text-align:left;border-bottom:1px solid var(--sepia-300);"><th style="padding:8px 12px 8px 0;">诊所</th><th style="padding:8px 12px;">针灸</th><th style="padding:8px 12px;">按摩 (RMT)</th></tr></thead><tbody><tr style="border-bottom:1px solid var(--sepia-100);"><td style="padding:8px 12px 8px 0;">列治文</td><td style="padding:8px 12px;">ICBC 直接结算</td><td style="padding:8px 12px;">ICBC 直接结算</td></tr><tr style="border-bottom:1px solid var(--sepia-100);"><td style="padding:8px 12px 8px 0;">本拿比</td><td style="padding:8px 12px;">ICBC 直接结算</td><td style="padding:8px 12px;">ICBC 直接结算</td></tr><tr style="border-bottom:1px solid var(--sepia-100);"><td style="padding:8px 12px 8px 0;">温哥华</td><td style="padding:8px 12px;">ICBC 直接结算</td><td style="padding:8px 12px;">提供（不走 ICBC）</td></tr><tr><td style="padding:8px 12px 8px 0;">白石</td><td style="padding:8px 12px;">ICBC 直接结算</td><td style="padding:8px 12px;">ICBC 直接结算</td></tr></tbody></table>',
        howTcmFootnote: null,
        treatments: ['acupuncture', 'tui-na', 'manual-bone-setting', 'floating-needle', 'cupping-gua-sha'],
        whatToExpect: '初诊会先做评估，再为你制定个性化方案；治疗常多法并用，并在复诊中持续观察、调整。具体频次与疗程因人而异。\n\n注册针灸通常可由 ICBC 承保——具体承保范围、次数与流程，请以 ICBC 当前规定为准。',
        whatToExpectFootnote: null,
        faqs: [
          {
            q: '针灸能用 ICBC 报销吗？',
            a: '注册针灸为 ICBC 认可；具体承保与次数请以当前规定为准。',
          },
          {
            q: '需要转介吗？',
            a: '可直接预约就诊；ICBC 理赔的转介与接案流程，欢迎联系诊所，由前台协助办理。',
          },
          {
            q: '车祸后多久可以来就诊？',
            a: '只要你觉得状态可以，就能预约。早期照护常用于缓解疼痛与僵硬、支持康复。',
          },
        ],
      },
      ...
      'headaches-migraines': {
        ...
        category: '身体与疼痛', categoryEn: 'Body & Pain',
        kind: 'headaches',
        seoTitle: '头痛与偏头痛 与中医调理 | 加西中医',
        seoDescription: '加西中医的头痛与偏头痛调理——针灸、头疗与手法理疗常用于舒缓颈肩紧张、支持神经系统；许多人在一段疗程后觉得头痛发作变少或减轻。',
        lede: '紧张性头痛与偏头痛——以稳健调理，让发作更轻、更少。',
        howTcm: '头痛常源于颈肩紧张、压力、睡眠不佳与久对屏幕。针灸、头疗与手法理疗常用于舒缓紧张、支持神经系统；许多人在一段疗程后觉得头痛发作变少或减轻。我们与偏头痛的常规医疗管理并行。',
        howTcmFootnote: null,
        ...
        faqs: [
          {
            q: '针灸对偏头痛有帮助吗？',
            a: '针灸常用于偏头痛的辅助调理——许多人经过一个疗程后，头痛发作变少或变轻。效果因人而异，我们与你的医疗管理协同进行。',
          },
          {
            q: '需要做多少次？',
            a: '因人而异。头痛通常以短疗程为主，医师会随你的反应重新评估、调整方案。',
          },
          {
            q: '偏头痛药物要继续吃吗？',
            a: '要——请继续遵医嘱用药与管理。我们是医疗照护的补充，而非替代。',
          },
        ],
      },
      ...
      'sleep-stress': {
        ...
        kind: 'sleep',
        seoTitle: '睡眠与压力 与中医调理 | 加西中医',
        seoDescription: '加西中医的睡眠与压力调理——针灸与头疗常用于安抚过度活跃的压力反应、支持睡眠，中药也可依体质配方。目标是可持续的改善——而非偶尔一夜好眠。',
        lede: '失眠、烦躁与身心耗竭——让神经系统沉静，睡得更好。',
        howTcm: '入睡难、易醒、思绪纷乱与身心俱疲常相伴而生。针灸与头疗常用于安抚过度活跃的压力反应、支持睡眠，中药也可依体质配方。目标是可持续的改善——而非偶尔一夜好眠。',
        howTcmFootnote: '中医称之为<em>安神</em>、重归平衡。',
        ...
        faqs: [
          {
            q: '多久能睡得更好？',
            a: '因人而异。有些人很快感到变化；多数人在一个短疗程内逐步改善。目标是可持续的改善——而非偶尔一夜好眠。',
          },
          {
            q: '需要配合中药吗？',
            a: '视情况而定。中药方剂会按你的体质辨证调配，并在复诊时复核调整。',
          },
          {
            q: '安眠药可以继续吃吗？',
            a: '可以——请继续遵医嘱用药与管理。我们与你的医疗照护协同，而非取代。',
          },
        ],
      },
      ...
      'womens-health': {
        ...
        kind: 'womens',
        seoTitle: '妇科健康 · 中医调理 | 加西中医',
        seoDescription: '加西中医的妇科健康调理——针灸、艾灸与因人配伍的中药常用于支持月经规律、缓解不适，并在激素变化中稳定情绪与睡眠，始终与你的常规医疗并行。',
        lede: '月经、更年期与女性调理——稳健而个性化的照护。',
        howTcm: '月经不规律或痛经、经前不适，以及围绝经期与更年期的种种变化，是许多女性寻求中医调理的方向。针灸、艾灸与因人配伍的中药常用于支持月经规律、缓解不适，并在激素变化中稳定情绪与睡眠——始终与你的常规医疗并行。',
        howTcmFootnote: null,
        ...
        faqs: [
          {
            q: '经期可以来吗？',
            a: '一般可以——许多治疗在经期同样适用，并会按周期阶段调整。请在问诊时告知你目前所处的周期阶段。',
          },
          {
            q: '中药会与我在服的药冲突吗？',
            a: '请在问诊时告知所有用药、补充剂与病史，医师会据此判断适合的方案。我们与你的医疗照护协同配合。',
          },
          {
            q: '只针对备孕吗？',
            a: '不是——这里的妇科调理涵盖月经、经前综合征、围绝经期与更年期及整体健康。备孕与孕产支持是另一个专门方向，请见「备孕与孕产」页面。',
          },
        ],
      },
      ...
      'fertility-pregnancy': {
        ...
        category: '女性与皮肤', categoryEn: 'Women & Skin',
        kind: 'fertility',
        seoTitle: '备孕与孕产 · 中医调理 | 加西中医',
        seoDescription: '加西中医的孕前、孕期与产后调理——作为支持性的辅助照护，与你的医疗团队并行。中医不能替代生殖或产科医疗，我们也不对受孕或结果作任何承诺。',
        lede: '孕前、孕期与产后的调理支持——与你的医疗团队并行的温和照护。',
        howTcm: '许多人在备孕、孕期及产后，将针灸与中医作为支持性的辅助调理——用于压力、睡眠、精力与整体状态。中医不能替代生殖或产科的医疗照护，我们也不对受孕或结果作任何承诺。我们与你的医生或生殖中心协同并行，并在各阶段格外谨慎地把握适宜性。',
        howTcmFootnote: null,
        treatments: ['acupuncture', 'herbal-medicine'],
        whatToExpect: '初诊会先做评估，再为你制定个性化方案；治疗常多法并用，并在复诊中持续观察、调整。具体频次与疗程因人而异。',
        whatToExpectFootnote: '孕期尤需谨慎——部分穴位、中药与手法会避免使用。如已怀孕或可能怀孕，请务必告知我们。',
        faqs: [
          {
            q: '孕期安全吗？',
            a: '部分方法可在孕期作为支持性调理使用，另一些则会避免。我们会格外谨慎，并与你的医疗团队协同。若已怀孕或可能怀孕，请务必告知。',
          },
          {
            q: '能帮助受孕吗？',
            a: '我们不作此类承诺。针灸与中医在这里是支持性的辅助照护，与你的医生或生殖团队协同——用于压力、睡眠、精力与整体状态。',
          },
          {
            q: '会与我的生殖诊所配合吗？',
            a: '会——我们与你的医生或生殖诊所协同，乐于配合既有方案。请带上治疗、用药与时间安排的细节，便于医师参考。',
          },
        ],
      },
      ...
      'skin-acne': {
        ...
        category: '女性与皮肤', categoryEn: 'Women & Skin',
        kind: 'skin',
        seoTitle: '皮肤与痤疮 · 中医调理 | 加西中医',
        seoDescription: '加西中医的皮肤与痤疮调理——因人配伍的中药、针灸与美容针常用于由内而外地支持更清透、更平衡的肌肤；循序渐进的整体调理，与任何皮肤科治疗并行。',
        lede: '痤疮、暗沉与肌肤平衡——由内而外地调理支持。',
        howTcm: '皮肤常映照体内状况——消化、睡眠、压力与激素平衡。因人配伍的中药、针灸与美容针常用于在调理这些内在根由的同时，支持更清透、更平衡的肌肤。是循序渐进的整体调理，而非速效；并与任何皮肤科治疗并行。',
        howTcmFootnote: null,
        ...
        faqs: [
          {
            q: '多久能看到变化？',
            a: '皮肤的改善是渐进的。多数人以疗程为单位复核进展，而非单次见效——改善往往与消化、睡眠、压力的变化同步累积。',
          },
          {
            q: '皮肤科的治疗要继续吗？',
            a: '要——请继续皮肤科医生的治疗与复诊。我们与皮肤科照护协同，而非替代。',
          },
          {
            q: '美容针和肉毒素一样吗？',
            a: '不一样。美容针使用极细的针灸针，属于整体中医调理的一部分——并非美容注射，作用方式也不同。',
          },
        ],
      },
      ...
      digestion: {
        ...
        category: '内调与养护', categoryEn: 'Internal & Wellness',
        kind: 'digestion',
        seoTitle: '消化调理 · 中医调理 | 加西中医',
        seoDescription: '加西中医的消化调理——针灸、艾灸与因人配伍的中药常用于支持消化舒适与规律，并兼顾与肠胃密切相关的压力与睡眠。我们是对消化症状常规医学检查的补充，而非替代。',
        lede: '腹胀、食欲与肠胃舒适——温和调理日常消化。',
        howTcm: '腹胀、食欲不定、消化迟缓与餐后不适，常见而恼人。针灸、艾灸与因人配伍的中药常用于支持消化舒适与规律，并兼顾与肠胃密切相关的压力与睡眠。我们是对消化症状常规医学检查的补充，而非替代。',
        howTcmFootnote: null,
        treatments: ['acupuncture', 'moxibustion', 'herbal-medicine'],
        whatToExpect: '初诊会先做评估，再为你制定个性化方案；治疗常多法并用，并在复诊中持续观察、调整。具体频次与疗程因人而异。',
        whatToExpectFootnote: null,
        faqs: [
          {
            q: '还需要看医生吗？',
            a: '需要。中医与医疗照护协同进行——请继续医生安排的检查、治疗与复诊。我们是消化症状医学排查的补充，而非替代。',
          },
          {
            q: '需要调整饮食吗？',
            a: '通常会在治疗之外聊聊进餐规律、时间与一些小调整——以贴近日常、容易执行为原则。',
          },
          {
            q: '需要配合中药吗？',
            a: '视情况而定。个性化的中药方剂会在复诊时复核调整。',
          },
        ],
      },
    },
  ...
  scanWechat: '扫码添加微信',
  footer: {
    tagline: ['自 2019 年起，', '于大温哥华用心传承的中医。'],
    columns: {
      locations: '门店',
      treatments: '诊疗项目',
      conditions: '调理方向',
    ...
    conditionNames: [
      '疼痛与损伤', 'ICBC 车祸康复', '睡眠与压力', '消化调理',
      '妇科健康', '备孕与孕产', '皮肤与痤疮', '头痛与偏头痛',
    ],
  ...
  locator: {
    eyebrow: '我们的诊所',
    h1: '四家诊所，均提供最高标准的医疗品质。',
    intro: '我们在大温哥华已发展到四家诊所——各有气质，却同守一个标准：注册中医师、一次性针具、本地煎制中药，以及中英双语的照护。',
    cards: [
      {
        key: 'richmond',
        city: '列治文',
        photo: 'assets/locations/hero-richmond-reception-1.jpg',
        alt: '加西中医列治文诊所的前台与中药柜',
        caption: '我们的旗舰店，位于 Cooney Road',
        address: '5611 Cooney Rd #130, Richmond, BC V6X 3J6',
        phone: '(604) 285-5778',
        href: 'Locations-Richmond-ZH.html',
      },
      {
        key: 'burnaby',
        city: '本拿比',
        photo: 'assets/locations/hero-burnaby-exterior-day.jpg',
        alt: '加西中医本拿比诊所日间的 Kingsway 店面',
        caption: '位于 Kingsway 沿线',
        address: '5665 Kingsway #125, Burnaby, BC V5H 2G4',
        phone: '(604) 423-9633',
        href: 'Locations-Burnaby-ZH.html',
      },
      {
        key: 'vancouver',
        city: '温哥华',
        ...
        alt: '加西中医温哥华诊所 West Broadway 入口',
        caption: 'Kitsilano，West Broadway 上',
        address: '3652 West Broadway, Vancouver, BC V6R 2B7',
        phone: '(778) 323-6356',
        href: 'Locations-Vancouver-ZH.html',
      },
      {
        key: 'whiterock',
        city: '白石',
        photo: 'assets/locations/hero-whiterock-exterior-day.jpg',
        alt: '加西中医白石诊所 Johnston Road 店面',
        caption: 'Johnston Road 海湾畔',
        address: '1549 Johnston Rd, White Rock, BC V4B 3Z6',
        phone: '(604) 560-6399',
        href: 'Locations-WhiteRock-ZH.html',
      },
    ],
    viewClinic: '查看该诊所 →',
    standardEyebrow: '无论到访哪一家，照护始终如一',
    standardPoints: [
      'BC 省注册中医师',
      '一次性针具与洁净床品',
      '中药房与现场煎药',
  ...
  richmond: {
    priceList: {
      ...
      groups: [
        { title: '传统养生治疗',
          note: '会员套餐每节 50 分钟；以上价格均未含税，另加 5% GST。',
          items: [
            { name: '推拿', sub: 'Tuina Massage', price: '$120', dur: '50分钟', pkg: '会员套餐 $960/10节' },
            { name: '艾灸', sub: 'Moxibustion', price: '$120', dur: '50分钟', pkg: '会员套餐 $960/10节' },
            { name: '理筋正骨', sub: 'Musculoskeletal Therapy', price: '$120', dur: '50分钟', pkg: '会员套餐 $960/10节' },
            { name: '拔罐', sub: 'Cupping', price: '$60/次', pkg: '会员综合治疗时可赠送' },
            { name: '刮痧', sub: 'Gua Sha', price: '$60/次', pkg: '会员综合治疗时可赠送' },
            { name: '火龙灸 / 扶阳透灸', sub: 'Fire Dragon / Fu Yang Moxibustion', price: '$220', dur: '90分钟', pkg: '套餐 $580/3次 · $1080/6次 · $1480/9次' },
            { name: '头疗', sub: 'Head Therapy', price: '$120', dur: '50分钟', pkg: '会员套餐 $960/10节' },
            { name: '全身淋巴排毒', sub: 'Full-Body Lymphatic Drainage', price: '$240', dur: '120分钟', pkg: '会员套餐 $1920/10次' },
            { name: '中药湿蒸舱', sub: 'Herbal Steam Cabin', price: '$88', dur: '40分钟', pkg: '会员套餐 $600/10次' },
            { name: '艾灸干蒸舱', sub: 'Moxibustion Dry-Heat Cabin', price: '$88', dur: '40分钟', pkg: '会员套餐 $600/10次' },
            { name: '生物电疗', sub: 'Bioelectric Therapy', price: '$180', dur: '75分钟', pkg: '会员套餐 $1450/10次' },
            { name: '女性胸部治疗', sub: 'Breast Wellness Therapy', price: '$180', dur: '75分钟', pkg: '会员套餐 $1450/10次' },
          ] },
        { title: '注册治疗',
          note: '注册治疗师项目不设任何预缴或套餐形式，仅限单次消费。',
          items: [
            { name: '针灸', sub: 'Acupuncture', price: '$120', dur: '50分钟' },
            { name: '注册按摩（RMT）', sub: 'Registered Massage Therapy', price: '$125+GST', dur: '50分钟' },
            { name: '专家中医脉诊', sub: 'Senior TCM Consultation', price: '$35/次+GST', pkg: '线上诊金 $100/次+GST' },
            { name: '普通中医脉诊', sub: 'TCM Consultation', price: '$35/次+GST', pkg: '同一位医师复诊免诊金 · 超过3个月未复诊则重新收取首诊费' },
          ] },
      ],
      footnote: '以上价格适用于列治文与本拿比门店，如有调整以门店现场为准；保险直付事宜请咨询前台。',
    },
    hero: {
      ...
      h1: '列治文',
      sub: '加西中医的起点。',
      chips: ['全周营业', 'ICBC · 针灸与按摩(RMT)', '完整中药房'],
      primary: '预约到访',
      primaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
    ...
    story: {
      eyebrow: '旗舰店',
      body: '列治文旗舰店是加西中医的起点。前台之后，是一间完整的传统中药房——一面逾百格的木制百子柜，每格存放一味药材，现场称量、抓配、煎制。这里最能体现我们是谁：以传承中医、按现代加拿大标准行医，在一个让人安心的空间里。',
      photo: 'assets/heritage/hero-richmond-herbal-cabinet-baizigui.jpg',
      alt: '加西中医列治文店的传统中药百子柜',
    },
    info: {
      eyebrow: '探访列治文',
      addressLabel: '地址',
      ...
      hoursNote: '节假日时间可能调整，建议来电确认。',
      phoneLabel: '电话',
      phone: '(604) 285-5778',
      transitLabel: '停车与交通',
      transit: '步行 8–12 分钟可达 Lansdowne 或 Richmond-Brighouse 加拿大线车站 · 楼内访客停车场（收费）',
      mapSrc: 'https://www.google.com/maps?q=5611+Cooney+Rd+%23130,+Richmond,+BC+V6X+3J6&output=embed',
      mapIframeTitle: '加西中医列治文店地图',
      directionsHref: 'https://www.google.com/maps/dir/?api=1&destination=5611+Cooney+Rd+%23130,+Richmond,+BC+V6X+3J6',
      directionsLabel: '导航前往 →',
    },
    gallery: {
      eyebrow: '走进诊所',
      h2: '店内一览。',
      cards: [
        { photo: 'assets/locations/richmond/hero-richmond-herbal-vessel-corridor.jpg', alt: '药材罐陈列走廊 · 加西中医列治文店' },
        { photo: 'assets/locations/richmond/hero-richmond-consultation-room.jpg', alt: '诊室 · 加西中医列治文店' },
        { photo: 'assets/locations/richmond/gallery-richmond-treatment-room-1.jpg', alt: '治疗室 · 加西中医列治文店' },
        { photo: 'assets/locations/richmond/gallery-richmond-interior-1.jpg', alt: '候诊区与绿植墙 · 加西中医列治文店' },
        { photo: 'assets/locations/richmond/gallery-richmond-credentials-wall.jpg', alt: '注册中医师资质墙 · 加西中医列治文店' },
      ],
    },
    find: {
      eyebrow: '这里有什么',
      h2: '列治文店的医师与疗法。',
      practitionersTitle: '列治文门店医师',
      practitioners: [
        {
          name: 'Taylor Wang',
          badge: '创始人',
        ...
        },
        {
          ...
          crop: '50% 22%',
          creds: ['R.TCM.P', 'R.Ac'],
          subtitle: '北京中医药大学针推系硕士 · 术后综合征 / 痛症 / 老年病',
        },
        {
          name: 'Jiabin Nan',
          badge: '30+ 年',
      ...
      services: [
        ...
        { name: '拔罐与刮痧', href: 'Treatments/cupping-gua-sha-ZH.html' },
        { name: '正骨', href: 'Treatments/manual-bone-setting-ZH.html' },
        { name: '头疗', href: 'Treatments/head-therapy-ZH.html' },
        { name: '精油芳香', href: 'Treatments-ZH.html' },
        { name: '中药', href: 'Treatments/herbal-medicine-ZH.html' },
        { name: '美容针', href: 'Treatments/aesthetic-acupuncture-ZH.html' },
        { name: '扶阳灸', href: 'Treatments/fuyang-moxibustion-ZH.html' },
        { name: '埋线减肥', href: 'Treatments/thread-embedding-ZH.html' },
        { name: '古法小颜针', href: 'Treatments/xiaoyan-facial-ZH.html' },
        { name: '面部拨筋', href: 'Treatments/facial-bojin-ZH.html' },
        { name: '中医暗疮治疗', href: 'Treatments/tcm-acne-ZH.html' },
      ],
    },
    neighbourhood: {
      eyebrow: '周边',
      line: '位于列治文核心地段，邻近 Richmond Centre，购物餐饮近在咫尺。',
      backLink: '查看我们的其他诊所 →',
      backHref: 'Locations-ZH.html',
    },
    sticky: {
      call: '致电',
      book: '预约',
  ...
  // ZH mirror of STRINGS.burnaby
  burnaby: {
    hero: {
      photo: 'assets/locations/burnaby/hero-burnaby-exterior-day.jpg',
      heroCrop: '55% 50%',
      alt: '加西中医本拿比店 Kingsway 日间店面',
      eyebrow: '本拿比 · Kingsway 沿线',
      h1: '本拿比',
      sub: '位于 Kingsway 沿线。',
      chips: ['全周营业', 'ICBC · 针灸与按摩(RMT)', '资深医师坐诊'],
      primary: '预约到访',
      primaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      primaryTarget: '_blank',
      secondary: '导航前往',
    ...
    story: {
      eyebrow: 'Kingsway 沿线',
      body: '我们的本拿比诊所坐落在繁忙的 Kingsway 沿线。入口处，一排亮灯展板列出店内开展的传统疗法——针灸、推拿、艾灸等等。这是一家最本真意义上的社区诊所：从容、经验丰富，也是我们几位最资深医师的坐诊之处。',
      photo: 'assets/locations/burnaby/hero-burnaby-exterior-day.jpg',
      alt: '加西中医本拿比店日间 Kingsway 店面',
    },
    info: {
      eyebrow: '探访本拿比',
      addressLabel: '地址',
      ...
      phone: '(604) 423-9633',
      transitLabel: '停车与交通',
      transit: '门口即 #19 Kingsway 巴士线 · 步行约 8–10 分钟可达 Metrotown SkyTrain · 商场共用停车场',
      mapSrc: 'https://www.google.com/maps?q=5665+Kingsway+%23125,+Burnaby,+BC+V5H+2G4&output=embed',
      mapIframeTitle: '加西中医本拿比店地图',
    ...
    gallery: {
      ...
      h2: '店内一览。',
      cards: [
        { photo: 'assets/locations/burnaby/gallery-burnaby-storefront-day.jpg', alt: '加西中医本拿比店日间店面外景' },
        { photo: 'assets/locations/burnaby/hero-burnaby-reception-1.jpg', alt: '前台 · 加西中医本拿比店' },
        { photo: 'assets/locations/burnaby/gallery-burnaby-treatment-room-1.jpg', alt: '治疗室 · 加西中医本拿比店' },
        { photo: 'assets/locations/burnaby/gallery-burnaby-corridor.jpg', alt: '治疗室走廊 · 加西中医本拿比店' },
        { photo: 'assets/locations/burnaby/gallery-burnaby-interior-1.jpg', alt: '室内 · 加西中医本拿比店' },
        { photo: 'assets/locations/burnaby/gallery-burnaby-credentials-wall.jpg', alt: '注册中医师资质墙 · 加西中医本拿比店' },
      ],
    },
    find: {
      eyebrow: '这里有什么',
      ...
      practitioners: [
        {
          ...
          crop: '50% 22%',
          creds: ['R.TCM.P.'],
          subtitle: '香港大学中医硕士 · 针药并用 · 内妇外科 / 慢性病',
        },
        {
          name: 'Monica Liu',
          photo: 'bby-monica-liu.jpg',
          crop: '50% 22%',
          creds: ['BC省注册指压师', '康复治疗师'],
          subtitle: '指压与康复治疗 · 颈肩腰腿疼痛',
        },
        {
          name: 'Jasmine Zhang',
          badge: '17 年',
      ...
      services: [
        ...
        { name: '中药', href: 'Treatments/herbal-medicine-ZH.html' },
        { name: '美容针', href: 'Treatments/aesthetic-acupuncture-ZH.html' },
        { name: '火龙灸', href: 'Treatments/fire-dragon-moxibustion-ZH.html' },
        { name: '埋线减肥', href: 'Treatments/thread-embedding-ZH.html' },
        { name: '古法小颜针', href: 'Treatments/xiaoyan-facial-ZH.html' },
        { name: '面部拨筋', href: 'Treatments/facial-bojin-ZH.html' },
        { name: '中医暗疮治疗', href: 'Treatments/tcm-acne-ZH.html' },
  ...
  // ZH mirror of STRINGS.vancouver
  vancouver: {
    priceList: {
      eyebrow: '服务项目与价格',
      h2: '温西店服务项目一览。',
      groups: [
        { title: '传统养生治疗',
          ...
          items: [
            { name: '推拿', sub: 'TCM Acupressure', price: '$120', dur: '50分钟' },
            { name: '艾灸', sub: 'Moxibustion', price: '$120', dur: '50分钟' },
            { name: '理筋正骨', sub: 'TCM Manual Bone Setting Therapy', price: '$120', dur: '50分钟' },
            { name: '拔罐', sub: 'Cupping', price: '$60', dur: '25分钟', pkg: '$120 · 50分钟' },
            { name: '刮痧', sub: 'Gua Sha', price: '$60', dur: '25分钟', pkg: '$120 · 50分钟' },
            { name: '臀疗', sub: 'Hip Therapy', price: '$120', dur: '50分钟' },
            { name: '古法头疗', sub: 'TCM Head Massage Therapy', price: '$130', dur: '50分钟' },
            { name: '精油头疗', sub: 'Aroma Head Massage Therapy', price: '$130', dur: '50分钟' },
            { name: '精油淋巴排毒', sub: 'Aroma Lymphatic Detox Therapy', price: '$260', dur: '100分钟' },
            { name: '多特瑞芳香治疗', sub: 'doTERRA Aromatherapy', price: '$145', dur: '50分钟' },
          ] },
        { title: '注册治疗',
          note: '注册治疗师项目不设任何预缴或套餐形式，仅限单次消费。',
          items: [
            { name: '针灸', sub: 'Acupuncture', price: '$120', dur: '50分钟' },
            { name: '注册按摩（RMT）', sub: 'Registered Massage Therapy', price: '$130+GST', dur: '50分钟' },
            { name: '中医脉诊', sub: 'Pulse Diagnosis', price: '$35/次', pkg: '开方抓药免诊金' },
          ] },
        { title: '加西中医特色治疗',
          note: '以上价格均未含税，另加 5% GST。',
          items: [
            { name: '扶阳灸', sub: 'Fire Dragon Moxibustion', price: '$220', dur: '90分钟', pkg: '套餐 $580/3次 · $1080/6次 · $1480/9次' },
            { name: '线雕减肥', sub: 'Acupoint Thread-Embedding Weight Management', price: '$850', dur: '100分钟', pkg: '全身 $1500/3次 · $3600/9次 · 局部 $450/3次' },
            { name: '小颜整骨', sub: 'Facial Bone Restructuring', price: '$500', dur: '100分钟', pkg: '套餐 $1500/3次 · $2000/5次 · $2400/8次' },
    ...
    hero: {
      ...
      heroCrop: '50% 100%',
      alt: '加西中医温哥华店 West Broadway 店面',
      eyebrow: '温哥华 · Kitsilano',
      h1: '温哥华',
      sub: '位于 Kitsilano 的 West Broadway。',
      chips: ['全周营业', 'ICBC · 仅针灸', '肌骨与运动康复'],
      primary: '预约到访',
      primaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      primaryTarget: '_blank',
      secondary: '导航前往',
    ...
    story: {
      eyebrow: '西区',
      body: '我们的温哥华诊所位于 Kitsilano 的 West Broadway——我们在城市西区的据点。这是一处安心、温暖的空间，提供全套传统疗法，医师在肌骨与运动康复方面尤为擅长。',
    ...
    gallery: {
      ...
      h2: '店内一览。',
      cards: [
        { photo: 'assets/locations/vancouver/gallery-vancouver-corridor-bright.jpg', alt: '治疗室走廊 · 加西中医温哥华店', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-interior-1.jpg', alt: '室内 · 加西中医温哥华店', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-interior-2.jpg', alt: '治疗空间 · 加西中医温哥华店', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-waiting-area.jpg', alt: '候诊区 · 加西中医温哥华店', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-storefront-glass.jpg', alt: 'West Broadway 店面 · 加西中医温哥华店', objectPosition: 'left top' },
      ],
    },
    find: {
      eyebrow: '这里有什么',
      h2: '温哥华店的医师与疗法。',
      practitionersTitle: '温哥华门店医师',
      practitioners: [
        {
          name: 'Taylor Wang',
          badge: '创始人',
        ...
        },
        {
          ...
          crop: '50% 22%',
          creds: ['R.TCM.P', '中医学硕士'],
          subtitle: '南京中医药大学中医学硕士 · 20年以上康复临床',
        },
      ],
      teamCta: { label: '查看全部医师团队 →', href: 'Practitioners-ZH.html' },
      servicesTitle: '本店提供的服务',
      services: [
        { name: '针灸', href: 'Treatments/acupuncture-ZH.html' },
        { name: '推拿', href: 'Treatments/tui-na-ZH.html' },
        { name: '艾灸', href: 'Treatments/moxibustion-ZH.html' },
        ...
        { name: '中药', href: 'Treatments/herbal-medicine-ZH.html' },
        { name: '美容针', href: 'Treatments/aesthetic-acupuncture-ZH.html' },
        { name: '淋巴排毒', href: 'Treatments-ZH.html' },
        { name: '运动康复', href: 'Treatments-ZH.html' },
        { name: '扶阳灸', href: 'Treatments/fuyang-moxibustion-ZH.html' },
        { name: '埋线减肥', href: 'Treatments/thread-embedding-ZH.html' },
        { name: '古法小颜针', href: 'Treatments/xiaoyan-facial-ZH.html' },
        { name: '面部拨筋', href: 'Treatments/facial-bojin-ZH.html' },
        { name: '中医暗疮治疗', href: 'Treatments/tcm-acne-ZH.html' },
        { name: '心理咨询', href: 'Treatments/counselling-ZH.html' },
      ],
    },
    neighbourhood: {
      eyebrow: '周边',
      line: '位于温哥华西区、Kitsilano 的 West Broadway 上。',
      backLink: '查看我们的其他诊所 →',
      backHref: 'Locations-ZH.html',
    },
    sticky: {
  ...
  // ZH mirror of STRINGS.whiterock
  whiterock: {
    hero: {
      photo: 'assets/locations/whiterock/hero-whiterock-storefront.jpg',
      heroCrop: '70% 60%',
      alt: '加西中医白石店 Johnston Road 店面',
      eyebrow: '白石 · 海滨栈桥',
      h1: '白石',
      sub: '坐落 Johnston Road 海滨栈桥旁——全加首家浮针诊所。',
      chips: ['浮针示范诊所', 'ICBC · 针灸与按摩(RMT)', '全周营业'],
      primary: '预约到访',
    ...
    info: {
      ...
      phone: '(604) 560-6399',
      transitLabel: '停车与交通',
      transit: '紧邻 White Rock Centre 巴士总站（可达 Surrey Central、Bridgeport SkyTrain）· 路边咪表 + 附近收费停车场',
      mapSrc: 'https://www.google.com/maps?q=1549+Johnston+Rd,+White+Rock,+BC+V4B+3Z6&output=embed',
      mapIframeTitle: '加西中医白石店地图',
    ...
    find: {
      ...
      practitioners: [
        ...
        },
        {
          ...
          crop: '50% 22%',
          creds: ['R.TCM.P'],
          subtitle: '脉诊 · 疑难杂症 · 妇科男科调理 · 呼吸道疾病',
        },
        {
          name: 'Vivian Chen',
          photo: 'wr-vivian-chen.jpg',
          crop: '50% 22%',
          creds: ['R.TCM.P', 'R.Ac', '中医世家'],
          subtitle: '痛症及运动损伤 · 更年期与青春期调理 · 小儿推拿',
        },
        {
          name: 'Cathy Luo',
          ...
          crop: '50% 22%',
          creds: ['R.TCM.P'],
          subtitle: '疏肝解郁 · 中医眼科 · 针灸美容 · 乳腺癌放化疗后护理',
        },
      ],
      teamCta: { label: '查看全部医师团队 →', href: 'Practitioners-ZH.html' },
      servicesTitle: '本店提供的服务',
      services: [
        { name: '浮针', href: 'Treatments/floating-needle-ZH.html' },
        { name: '针灸', href: 'Treatments/acupuncture-ZH.html' },
        { name: '推拿', href: 'Treatments/tui-na-ZH.html' },
        { name: '艾灸', href: 'Treatments/moxibustion-ZH.html' },
        { name: '拔罐与刮痧', href: 'Treatments/cupping-gua-sha-ZH.html' },
    ...
    neighbourhood: {
      eyebrow: '周边',
      line: '就在 Johnston Road 的海滨栈桥旁，白石小城的中心地带。',
      backLink: '查看我们的其他诊所 →',
      backHref: 'Locations-ZH.html',
    },
    featureBand: {
...
COPY.faq = {
  zh: {
    seoTitle: '常见问题 | 加西中医',
    seoDescription: '加西中医的常见问题——关于针灸、ICBC 与附加健康保险、首次就诊体验、孕期与用药下的中药安全、双语服务与预约方式的简明回答。',
    hero: {
      eyebrow: '常见问题',
      h1: '常见疑问，如实作答。',
      sub: '来诊前最常被问到的，给你一份诚恳的回答。如果这里没有你的问题，欢迎随时来问。',
    },
    items: [
      { q: '需要转介吗？', a: '不需要——可直接预约。ICBC 理赔可由前台协助办理相关流程。', schema: false },
      { q: '针灸会痛吗？', a: '多数人仅感轻微刺入，随后是沉重或温热感。针具均为无菌一次性。', schema: true },
      { q: '需要做几次？', a: '因人、因症而异——通常为短疗程，并随进展调整。', schema: true },
...
COPY.firstVisit = {
  zh: {
    seoTitle: '首次就诊指南 | 加西中医',
    seoDescription: '加西中医的首次就诊指南——衣着建议、问诊与脉舌评估的流程、量身安排的诊疗与复诊安排。',
    hero: {
      eyebrow: '首次就诊',
      h1: '第一次来，会是怎样。',
      sub: '一次安静而周到的初诊——评估、诊疗，再为你安排接下来的复诊。',
    },
    steps: [
      { n: '01', h3: '来前准备', body: '穿宽松舒适的衣物。来前吃些清淡的，别完全空腹。带上用药清单与相关检查报告。' },
      { n: '02', h3: '评估',     body: '医师会询问你的病史与目标，并诊脉、看舌——这是辨识体质的传统方法。' },
      { n: '03', h3: '你的诊疗', body: '诊疗依你当天情况量身安排——常为针灸配合手法、艾灸或拔罐。任何不适请随时告知。' },
      { n: '04', h3: '之后与复诊', body: '你或感放松、略有倦意。我们会建议方案与居家调养，并在复诊时检视调整。' },
    ],
    details: {
      eyebrow: '几点实用说明',
      items: [
        { label: '初诊大约多久？', body: '请预留充足时间，以完成问诊与诊疗。' },
        { label: '该穿什么？',     body: '宽松舒适的衣物。如有需要，我们提供诊疗服。' },
        { label: '费用如何？',     body: '各项目收费不同——预约时请向诊所咨询。' },
        { label: '费用如何结算？', body: '结算与保险方式因诊所、保险公司而异，预约时请向诊所确认具体安排。' },
      ],
    },
    cta: {
      headline: '准备预约？',
      sub: '选择离你最近的诊所，或先了解我们的医师团队。',
      primary: '预约到访',
      primaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      secondary: '浏览全部医师 →',
      secondaryHref: 'Practitioners-ZH.html',
    },
  },
};
...
COPY.contact = {
  zh: {
    seoTitle: '联系我们 | 加西中医',
    seoDescription: '加西中医的联系方式与四家诊所地址：列治文、本拿比、温哥华与白石。电话、营业时间与联系表单。',
    hero: {
      eyebrow: '联系我们',
      h1: '找到我们，致电，到访。',
      sub: '大温哥华四家诊所——还有一个随时欢迎来信的安静信箱。',
    },
    napEyebrow: '我们的诊所',
    clinics: [
      { city: '列治文', address: '5611 Cooney Rd #130, Richmond, BC V6X 3J6', phone: '(604) 285-5778', hours: '周一至周日 10:00–18:30', href: 'Locations-Richmond-ZH.html',   directions: 'https://maps.google.com/?q=5611+Cooney+Rd+Richmond+BC',     lat: 49.1773, lng: -123.1377 },
      { city: '本拿比', address: '5665 Kingsway #125, Burnaby, BC V5H 2G4',    phone: '(604) 423-9633', hours: '周一至周日 10:00–18:30', href: 'Locations-Burnaby-ZH.html',    directions: 'https://maps.google.com/?q=5665+Kingsway+Burnaby+BC',       lat: 49.2233, lng: -123.0029 },
      { city: '温哥华', address: '3652 West Broadway, Vancouver, BC V6R 2B7',  phone: '(778) 323-6356', hours: '周一至周日 10:00–18:30', href: 'Locations-Vancouver-ZH.html',  directions: 'https://maps.google.com/?q=3652+West+Broadway+Vancouver+BC', lat: 49.2643, lng: -123.1850 },
      { city: '白石',   address: '1549 Johnston Rd, White Rock, BC V4B 3Z6',   phone: '(604) 560-6399', hours: '周一至周日 9:30–19:00',  href: 'Locations-WhiteRock-ZH.html',  directions: 'https://maps.google.com/?q=1549+Johnston+Rd+White+Rock+BC',  lat: 49.0289, lng: -122.8025 },
    ],
    form: {
      eyebrow: '写信给我们',
      h2: '欢迎来信——我们会认真读完每一封。',
...
STRINGS.faq = COPY.faq;
STRINGS.firstVisit = COPY.firstVisit;
STRINGS.contact = COPY.contact;
STRINGS.about = COPY.about;

// ============================================================
// PRACTITIONERS — team archive (Practitioners-ZH.html)
// Chrome localized; list is the SAME canonical data as the EN page
// (English clinics/roles/badge for filtering; creds bilingual; names stay English).
// ============================================================
COPY.practitionersArchive = {
  zh: {
    seoTitle: '中医师团队 — 大温的中医医师 | 加西中医',
    seoDescription: '认识加西中医 30+ 位 BC 省注册医师，遍布列治文、本拿比、温哥华与白石——中医师、针灸师、康复治疗师、注册按摩师与美容师，受训于北京、广州、辽宁、成都、香港与温哥华。',
    hero: {
      eyebrow: '中医师团队',
      h1: '历经数十年沉淀的团队。',
      lede: '在北京、广州、辽宁、成都、香港与温哥华受训——如今在太平洋这一侧执业。',
    },
    sections: {
      founders: { title: '核心团队', sub: 'Founders & Senior Practitioners' },
      all: { title: '全体医师', sub: 'All Practitioners' },
      rmt: { title: '注册按摩师', sub: 'Registered Massage Therapists' },
    },
    filters: {
      locationLabel: '门店',
      roleLabel: '角色',
      locations: ['全部', '列治文', '本拿比', '温哥华', '白石'],
      locationKeys: ['All', 'Richmond', 'Burnaby', 'Vancouver', 'White Rock'],
      roles: ['全部', '中医师', '针灸师', '康复治疗师', '注册按摩师', '美容师', '客服'],
      roleKeys: ['All', 'TCM Doctor', 'Acupuncturist', 'Rehabilitation Therapist', 'RMT', 'Aesthetician', 'Customer Care'],
      empty: '暂无符合所选条件的医师。',
    },
    clinicNames: { Richmond: '列治文', Burnaby: '本拿比', Vancouver: '温哥华', 'White Rock': '白石' },
    badgeMap: { '50+ years': '50+ 年', '36 years': '36 年', '30+ years': '30+ 年', '20+ years': '20+ 年', 'Founder': '创始人', 'White Rock Founder': '白石创办人' },
    rmtEyebrow: 'Registered Massage Therapists · 注册按摩师',
    photoComingSoon: '照片即将上线',
    viewProfile: '查看简介 →',
    viewProfileComingSoon: '简介即将上线',
    cta: {
      h2: '想找具体的调理方向或疗法？',
      tiles: [
        { label: '浏览诊疗项目 →', href: 'Treatments-ZH.html' },
        { label: '浏览调理方向 →', href: 'Conditions-ZH.html' },
      ],
      primary: '预约到访',
      primaryHref: 'https://canadianwesterntcmclinic.janeapp.com',
      secondary: '查找最近的诊所 →',
  ...
  detailChrome: {
    breadcrumbHome: '中医师团队',
    breadcrumbHomeHref: 'Practitioners-ZH.html',
    clinicNames: { Richmond: '列治文', Burnaby: '本拿比', Vancouver: '温哥华', 'White Rock': '白石' },
    eyebrows: {
      bio: '简介',
      specialties: '擅长',
    ...
    whereEyebrow: (first) => '出诊门店',
    testimonialsPlaceholder: '患者反馈即将上线',
    bookWith: (first) => `与 ${first} 预约到访 →`,
    bookHeadline: (first) => '为你预约一次到访。',
    bookPrimary: '预约到访',
    bookHref: 'https://canadianwesterntcmclinic.janeapp.com',
    browseTeam: '浏览医师团队 →',
    browseTeamHref: 'Practitioners-ZH.html',
    photoComingSoon: '照片即将上线',
    viewClinic: '进入诊所 →',
    locationPrefix: 'Locations-',
    locationSuffix: '-ZH.html',
  },
  ...
  details: {
    "jiabin-nan": {"seoTitle": "Jiabin Nan — Acupuncturist · R.Ac | Canadian Western TCM", "seoDescription": "Jiabin Nan, registered acupuncturist at Canadian Western TCM — over 30 years of clinical experience across Europe and North America, graduate of Beijing University of Chinese Medicine, practising in Richmond.", "creds": [{"en": "R.Ac", "zh": "BC省注册针灸师"}], "ledeEn": "Registered acupuncturist with over 30 years of clinical experience across Europe and North America.", "ledeZh": "三十余年欧洲与北美临床经验的注册针灸师。", "bioEn": "Jiabin Nan graduated from Beijing University of Chinese Medicine and has practised and taught in several countries across Europe and North America. With over 30 years of clinical experience in TCM, he has developed extensive expertise in pain-related conditions such as sports injuries, headaches, frozen shoulder and lumbar strain. He also has strong clinical results with facial paralysis, post-stroke hemiplegia, menstrual irregularities and insomnia, as well as paediatric concerns including enuresis, growth delays and digestive issues.", "bioZh": "毕业于北京中医学院（今北京中医药大学），曾在欧洲及北美多国行医与教学。三十余年中医临床经验，擅长运动损伤、头痛、五十肩、腰肌劳损等各类痛症，并在面瘫、中风后偏瘫、月经不调与失眠方面临床疗效显著；对小儿遗尿、生长迟缓及消化不良亦有独到调理。", "specialties": [{"en": "Acupuncture", "zh": "针灸"}, {"en": "Tuina", "zh": "推拿"}, {"en": "Pain Management", "zh": "痛症调理"}, {"en": "Paediatric TCM", "zh": "小儿调理"}], "conditions": [{"slug": "pain-injury", "en": "Pain & Injury", "zh": "疼痛与损伤"}, {"slug": "headaches-migraines", "en": "Headaches & Migraines", "zh": "头痛与偏头痛"}, {"slug": "womens-health", "en": "Women's Health", "zh": "妇科健康"}, {"slug": "sleep-stress", "en": "Sleep & Stress", "zh": "睡眠与压力"}], "treatments": [{"slug": "acupuncture", "en": "Acupuncture", "zh": "针灸"}, {"slug": "tui-na", "en": "Tui Na", "zh": "推拿"}], "educationEn": ["Beijing University of Chinese Medicine (Beijing College of TCM)", "30+ years of clinical practice across Europe & North America", "Clinical practice and teaching in multiple countries"], "educationZh": ["北京中医学院（今北京中医药大学）", "欧洲与北美 30+ 年临床", "多国行医与教学"], "languages": [{"en": "Mandarin", "zh": "普通话"}, {"en": "English", "zh": "英语"}]},
      ...
      "lynn-liu": {"seoTitle": "Lynn Liu | Canadian Western TCM", "seoDescription": "Lynn Liu, registered TCM practitioner at Canadian Western TCM — 20+ years of clinical rehabilitation, Master's from Nanjing University of Chinese Medicine, across Vancouver and Richmond.", "creds": [{"en": "R.TCM.P", "zh": "BC省注册中医师"}, {"en": "Master of TCM", "zh": "中医学硕士"}], "ledeEn": "Registered TCM practitioner with 20+ years in clinical rehabilitation, blending acupuncture, Tuina and herbal medicine.", "ledeZh": "拥有20年以上康复临床经验的注册中医师，融合针灸、推拿与中草药。", "bioEn": "Lynn Liu graduated from Anhui University of Traditional Chinese Medicine in acupuncture and Tuina, and earned a Master's degree from Nanjing University of Chinese Medicine. With 20+ years of clinical rehabilitation experience, she combines acupuncture, Tuina and herbal medicine to support pain management, digestive and menstrual health, stroke rehabilitation, sleep concerns and constitutional wellness.", "bioZh": "毕业于安徽中医药大学针灸推拿专业，并获南京中医药大学中医学硕士学位，具江苏省高级专业技术资格。从事中医康复临床20年以上，擅长运用针灸、推拿及中草药调理痛证、消化系统疾病、月经不调、中风后遗症、睡眠障碍及体质。", "specialties": [{"en": "Acupuncture", "zh": "针灸"}, {"en": "Tuina", "zh": "推拿"}, {"en": "Chinese Herbal Medicine", "zh": "中草药"}, {"en": "Stroke Rehabilitation", "zh": "中风康复"}, {"en": "Constitutional Wellness", "zh": "体质调理"}], "conditions": [{"slug": "pain-injury", "en": "Pain & Injury", "zh": "疼痛与损伤"}, {"slug": "digestion", "en": "Digestion", "zh": "消化调理"}, {"slug": "womens-health", "en": "Women's Health", "zh": "妇科健康"}, {"slug": "sleep-stress", "en": "Sleep & Stress", "zh": "睡眠与压力"}], "treatments": [{"slug": "acupuncture", "en": "Acupuncture", "zh": "针灸"}, {"slug": "tui-na", "en": "Tui Na", "zh": "推拿"}, {"slug": "herbal-medicine", "en": "Herbal Medicine", "zh": "中药调理"}], "educationEn": ["Anhui University of TCM — Acupuncture & Tuina", "Nanjing University of Chinese Medicine — Master's degree", "20+ years of clinical rehabilitation; senior professional-technical qualification (Jiangsu)"], "educationZh": ["安徽中医药大学 — 针灸推拿", "南京中医药大学 — 中医学硕士", "20年以上康复临床；江苏省高级专业技术资格"], "languages": [{"en": "Mandarin", "zh": "普通话"}, {"en": "English", "zh": "英语"}]},
    ...
    'wingho-chan': {
      ...
      "bioEn": "Wingho Chan graduated from The University of Hong Kong with a Master’s degree in Traditional Chinese Medicine. He specializes in integrating acupuncture and herbal medicine with TCM principles and modern medical knowledge to treat internal medicine conditions, gastrointestinal issues, chronic illnesses, and gynecological disorders. Wingho also has expertise in TCM dermatology, utilizing herbal therapies for skin conditions. Additionally, he is proficient in traditional bone-setting and gentle Tuina, providing personalized, comprehensive care tailored to each patient’s condition and lifestyle.",
      "specialties": [
        {
...
STRINGS.journalPage = {
  eyebrow: '资讯',
  title: '诊所的话语，即将上线。',
  body: '我们的编辑专栏即将上线——中医入门、病症深度、本草、患者故事与诊所日常。订阅后第一时间获取首期内容。',
  cta: '先去看看医师团队 →',
  ctaHref: 'Practitioners-ZH.html',
  expected: '筹备中 · 敬请期待',
};
