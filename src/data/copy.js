...
export const COPY = {
  ...
  practitioners: {
    ...
    sub: "Our team of 30+ BC-registered practitioners includes a senior physician with 50 years of clinical experience, a FSN specialist, and graduates of Beijing, Guangzhou, Liaoning, Chengdu, Hong Kong and Vancouver schools of TCM.",
    cards: [
      {
      ...
      },
      {
        ...
        creds: ["R.TCM.P."],
        subtitle: "President of FSNAC · Acupuncture Instructor, Kwantlen Polytechnic University",
        clinic: "WHITE ROCK",
      },
      {
  ...
  conditions: {
    ...
    cards: [
      ...
      { slug: "fertility-pregnancy", icon: "fertility", title: "Fertility & Pregnancy", body: "Pre-conception support through trimesters." },
      { slug: "skin-acne", icon: "skin", title: "Skin & Acne", body: "Whole-body approach beyond topical fixes." },
      { slug: "headaches-migraines", icon: "headache", title: "Headaches & Migraines", body: "Pattern-based diagnosis and prevention." },
  ...
  locations: {
    ...
    cards: [
      ...
      { city: "White Rock", caption: "By the pier on Johnston Road · Specialty in FSN therapy", address: "1549 Johnston Rd, White Rock, BC V4B 3Z6",
...
export const STRINGS = {
  ...
  practitioners: {
    ...
    details: {
      'bill-wang': {
        seoTitle: 'Bill Wang (王旭彪), R.Ac. — He’s Three-Method Acupuncture | Canadian Western TCM',
        seoDescription: 'Meet Bill Wang (王旭彪), a BC registered acupuncturist at Canadian Western TCM Burnaby who has studied He Puren’s Three-Method Acupuncture system since 2017.',
        ...
        moreHref: 'Treatments/he-puren-three-method-acupuncture.html',
        moreLabel: 'Learn about He’s Three-Method Acupuncture →',
      },
    ...
    list: [
      ...
      // ---- BURNABY-based ----
      { slug: 'bill-wang', name: 'Bill Wang', clinics: ['Burnaby'], roles: ['Acupuncturist'], photo: 'bby-bill-wang.webp', badge: 'He’s Three-Method Acupuncture',
        creds: [{ en: 'R.Ac.', zh: 'BC省注册针灸师' }] },
  ...
  about: {
    en: {
      ...
      team: {
        ...
        body: "Our 30+ practitioners include a senior physician with 50 years in practice, a FSN specialist who founded Canada's first demonstration clinic, and graduates of Beijing, Guangzhou, Liaoning and Chengdu schools of Traditional Chinese Medicine — all registered in British Columbia.",
      ...
      clinics: {
        ...
        cards: [
          ...
          { city: 'White Rock', line: 'By the pier on Johnston Road.',       href: 'Locations-WhiteRock.html', badge: "Canada's first FSN clinic" },
        ],
...
treatments: {
  ...
  seoTitle: 'TCM Treatments — Acupuncture, Herbal Medicine, Tui Na, FSN | Canadian Western TCM',
    seoDescription: 'Acupuncture, tui na, moxibustion, cupping, manual bone setting, head therapy, herbal medicine, FSN, aesthetic acupuncture and registered massage therapy — traditional TCM, practised to a modern standard, across four Greater Vancouver clinics.',
    hero: {
      eyebrow: 'Treatments',
    ...
    groups: [
      ...
      },
      {
        ...
        zh: '加西特色',
        cards: [
          { slug: 'floating-needle',    name: 'FSN',  sub: '浮针',     tagline: 'A modern, near-painless technique for muscular and myofascial pain.', kind: 'fsn'    },
          { slug: 'he-puren-three-method-acupuncture', name: 'He’s Three-Method Acupuncture', sub: '贺氏针灸三通法', tagline: 'A lineage-based system of fine-needle, warming and strong-unblocking methods.', kind: 'needle' },
    ...
    details: {
      'he-puren-three-method-acupuncture': {
        ...
        name: 'He’s Three-Method Acupuncture', nameZh: '贺氏针灸三通法',
        category: 'Lineage acupuncture · Burnaby',
        kind: 'needle',
        compactTextGrid: true,
        lede: 'A structured acupuncture system developed by Professor He Puren, bringing fine-needle, warming and strong-unblocking methods together through individual assessment.',
        seoTitle: 'He Puren’s Three-Method Acupuncture in Burnaby | Bill Wang, R.Ac.',
        seoDescription: 'Learn about He Puren’s Three-Method Acupuncture at Canadian Western TCM Burnaby with Bill Wang, R.Ac.—the system’s lineage, three methods, safety and what to expect.',
        whatIsIt: [
          'He Puren’s Three-Method Acupuncture is a lineage-based clinical system developed by Professor He Puren. It organizes treatment through three complementary approaches known as Weitong, Wentong and Qiangtong.',
          'Professor He Puren was recognized as a first-batch representative inheritor of China’s national intangible cultural heritage project “Acupuncture.” The national designation applies to the project Acupuncture; He’s Three-Method system is his clinical and academic contribution within that tradition.',
          'At Canadian Western TCM Burnaby, Bill Wang, R.Ac. applies this framework together with TCM pattern differentiation, meridian theory and individualized point selection.',
        ],
        whatIsItFootnote: 'The choice of method depends on the person, presentation and clinical assessment. A named technique does not guarantee a particular result.',
        whatToExpect: [
          'Your visit begins with a health history and an acupuncture assessment. Bill explains which approach is being considered and obtains consent before treatment.',
          'Depending on suitability, care may use fine needles, a warming method that can include fire needle, or a stronger unblocking method that can include controlled bloodletting. Not every visit uses all three.',
          'Needles and lancets are sterile and single-use. Fire-needle and bloodletting techniques are used only when clinically appropriate and after risks, alternatives and aftercare have been discussed.',
        ],
        featureMedia: {
          eyebrow: 'Clinical demonstration',
          title: 'A brief look at the warming method.',
          body: 'This short clip demonstrates a fire-needle step used within the warming approach. It is shown for education only; technique selection and treatment are individualized.',
          note: 'Clinical procedure shown. Viewer discretion is advised. No outcome is implied by this demonstration.',
          caption: 'Fire-needle demonstration at Canadian Western TCM. 38 seconds.',
          video: 'assets/treatments/he-three-method-fire-needle.mp4',
          poster: 'assets/treatments/he-three-method-fire-needle-poster.webp',
          schemaName: 'Fire-needle demonstration — He Puren’s Three-Method Acupuncture',
          schemaDescription: 'A short educational demonstration of a fire-needle step used within the warming method at Canadian Western TCM.',
          duration: 'PT38S',
        ...
        richSections: [
          {
            ...
            html: '<h3>Weitong · fine-needle method</h3><p>Uses fine needles and meridian-based point selection to support regulation and function.</p><h3>Wentong · warming method</h3><p>Uses warming techniques, which may include fire needle, when warmth is clinically appropriate.</p><h3>Qiangtong · strong-unblocking method</h3><p>May include controlled bloodletting for selected presentations. It is not appropriate for every person and requires specific assessment and consent.</p>',
          },
          {
            title: 'Clinical focus',
            html: '<p>Bill’s clinical focus includes supportive care for neurological and functional rehabilitation; acute and chronic pain; spine, joint and soft-tissue concerns; headaches; sleep and stress; digestive function; women’s health; selected skin concerns; and constitutional wellness.</p><p>Acupuncture is complementary care. New, severe or worsening symptoms should be assessed by an appropriate medical professional, and emergencies require 911 or the nearest emergency department.</p>',
          },
          {
            title: 'Authorization & suitability',
            html: '<p>For further information about Bill Wang’s authorization and lineage background, call Canadian Western TCM Burnaby at <a href="tel:+16044239633">(604) 423-9633</a>.</p><p>To ask whether He’s Three-Method Acupuncture may be suitable for you, speak with a registered acupuncturist. The actual treatment plan is determined only after an individual assessment.</p>',
          },
        ],
        lineageSpotlight: {
          photo: 'assets/heritage/he-xi.webp',
          alt: 'Professor He Xi, lineage teacher of He Puren’s Three-Method Acupuncture',
          eyebrow: 'Lineage',
          title: 'Guided by Professor He Xi.',
          body: 'Since 2017, Bill has received ongoing theoretical, clinical and practical guidance from Professor He Xi, the son of Professor He Puren and a representative lineage practitioner of the system.',
          link: 'View the official national ICH record for Professor He Puren →',
        ...
        practitionersNote: 'At our Burnaby clinic, Bill Wang, R.Ac. offers this approach following an individual assessment.',
        practitionerHref: 'Practitioners/bill-wang.html',
        practitionerLabel: 'Meet Bill Wang →',
        related: ['acupuncture', 'moxibustion', 'cupping-gua-sha'],
        bookHeadline: 'Ask whether this approach fits your needs.',
        bookSub: 'Book with our Burnaby clinic or call (604) 423-9633 for more information.',
      },
      acupuncture: {
        slug: 'acupuncture',
      ...
      'floating-needle': {
        ...
        seoTitle: 'FSN — what it is, what to expect | Canadian Western TCM',
        seoDescription: "Fu's Subcutaneous Needling (FSN) at Canadian Western TCM — a modern, near-painless technique for muscular and myofascial pain. Our White Rock clinic is Canada's first dedicated FSN demonstration clinic.",
        whatIsIt: [
          "Fu's Subcutaneous Needling (FSN) works in the layer just under the skin, using a soft, sweeping movement rather than deep insertion.",
  ...
  conditions: {
    ...
    details: {
      'pain-injury': {
        ...
        seoDescription: 'Pain and injury at Canadian Western TCM — acupuncture, tui na, cupping, manual bone setting, FSN and moxibustion to release muscle and fascia tension, calm the pain response and restore movement and circulation. Educational guide and what to expect.',
  ...
  locator: {
    ...
    ctaLine: 'Find the clinic near you and book a visit.',
      ...
      groups: [
        ...
        { title: 'Registered Care',
          ...
          items: [
            ...
            { name: 'Senior TCM Consultation & Pulse Diagnosis', price: '$35 + GST / visit', pkg: 'Virtual consultation $100 + GST / visit' },
            { name: 'TCM Consultation & Pulse Diagnosis', price: '$35 + GST / visit', pkg: 'Follow-up with the same practitioner is complimentary · initial fee reapplies after 3 months without a visit' },
          ] },
      ],
  ...
  burnaby: {
    ...
    find: {
      ...
      practitioners: [
        {
          ...
          crop: '50% 20%',
          creds: ['R.Ac.'],
          badge: 'He’s Three-Method Acupuncture',
          subtitle: 'Lineage-based acupuncture · practising the three-method system since 2017',
        },
        {
          name: 'Wingho Chan',
          photo: 'bby-wing-ho-chan.jpg',
      ...
      teamCta: { label: 'View all practitioners on our Team page →', href: 'Practitioners.html' },
      services: [
        { name: 'He’s Three-Method Acupuncture', href: 'Treatments/he-puren-three-method-acupuncture.html' },
        { name: 'Acupuncture', href: 'Treatments/acupuncture.html' },
        { name: 'Tui Na', href: 'Treatments/tui-na.html' },
        { name: 'Moxibustion', href: 'Treatments/moxibustion.html' },
        { name: 'Cupping & Gua Sha', href: 'Treatments/cupping-gua-sha.html' },
  ...
  vancouver: {
    priceList: {
      ...
      groups: [
        { title: 'Traditional Wellness Treatments',
          ...
          items: [
            { name: 'TCM Acupressure', price: '$120', dur: '50 min' },
            { name: 'Moxibustion', price: '$120', dur: '50 min' },
            { name: 'TCM Manual Bone Setting Therapy', price: '$120', dur: '50 min' },
            { name: 'Cupping', price: '$60', dur: '25 min', pkg: '$120 · 50 min' },
            { name: 'Gua Sha', price: '$60', dur: '25 min', pkg: '$120 · 50 min' },
            { name: 'Hip Therapy', price: '$120', dur: '50 min' },
            { name: 'TCM Head Massage Therapy', price: '$130', dur: '50 min' },
            { name: 'Aroma Head Massage Therapy', price: '$130', dur: '50 min' },
            { name: 'Aroma Lymphatic Detox Therapy', price: '$260', dur: '100 min' },
            { name: 'doTERRA Aromatherapy', price: '$145', dur: '50 min' },
          ] },
        { title: 'Registered Care',
          note: 'Claimable services are single-session purchases only — no packages or prepayment plans.',
          items: [
            { name: 'Acupuncture', price: '$120', dur: '50 min' },
            { name: 'Registered Massage Therapy (RMT)', price: '$130 + GST', dur: '50 min' },
            { name: 'TCM Consultation & Pulse Diagnosis', price: '$35 / session', pkg: 'Consultation fee waived when filling a herbal prescription' },
          ] },
        { title: 'CWTCM Special Treatments',
          note: 'Prices before tax — 5% GST applies.',
          items: [
            { name: 'Fire Dragon Moxibustion', price: '$220', dur: '90 min', pkg: 'Packages $580 / 3 · $1080 / 6 · $1480 / 9' },
            { name: 'Acupoint Thread-Embedding Weight Management', price: '$850', dur: '100 min', pkg: 'Full body $1500 / 3 · $3600 / 9 · partial $450 / 3' },
            { name: 'Facial Bone Restructuring', price: '$500', dur: '100 min', pkg: 'Packages $1500 / 3 · $2000 / 5 · $2400 / 8' },
    ...
    gallery: {
      ...
      h2: 'A look around.',
      cards: [
        { photo: 'assets/locations/vancouver/gallery-vancouver-corridor-bright.jpg', alt: 'Treatment-room corridor at Canadian Western TCM Vancouver clinic', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-interior-1.jpg', alt: 'Interior at Canadian Western TCM Vancouver clinic', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-interior-2.jpg', alt: 'Treatment space at Canadian Western TCM Vancouver clinic', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-waiting-area.jpg', alt: 'Waiting area at Canadian Western TCM Vancouver clinic', objectPosition: 'left top' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-storefront-glass.jpg', alt: 'Storefront on West Broadway at Canadian Western TCM Vancouver clinic', objectPosition: 'left top' },
      ],
    },
    find: {
      eyebrow: 'What you\u2019ll find here',
      ...
      practitioners: [
        ...
        },
        {
          ...
          subtitle: 'Nanjing University of Chinese Medicine · 20+ years in clinical rehabilitation',
        },
      ],
      teamCta: { label: 'View all practitioners on our Team page →', href: 'Practitioners.html' },
  ...
  whiterock: {
    hero: {
      ...
      h1: 'White Rock',
      sub: "By the pier on Johnston Road \u2014 Canada\u2019s first FSN clinic.",
      chips: ['FSN demonstration clinic', 'ICBC — acupuncture & massage (RMT)', 'Open 7 days'],
      primary: 'Book a Visit',
    ...
    gallery: {
      ...
      cards: [
        ...
        },
        {
          ...
          alt: 'FSN therapy in progress at White Rock',
          caption: 'FSN therapy in progress',
        },
        {
    ...
    find: {
      ...
      servicesTitle: 'Services offered here',
      services: [
        { name: 'FSN', href: 'Treatments/floating-needle.html' },
        { name: 'Acupuncture', href: 'Treatments/acupuncture.html' },
        { name: 'Tui Na', href: 'Treatments/tui-na.html' },
        { name: 'Moxibustion', href: 'Treatments/moxibustion.html' },
        { name: 'Cupping & Gua Sha', href: 'Treatments/cupping-gua-sha.html' },
...
STRINGS.customerCare = {
  ...
  availablePhotos: [],
  list: [
    { slug: 'angel-lai', name: 'Angel Lai', clinics: ['Richmond'], role: 'Customer Service Supervisor', photo: 'reception-rmd-angel-lai.jpg' },
    { slug: 'serena-chen', name: 'Serena Chen', clinics: ['Burnaby'], role: 'Customer Service Supervisor', photo: 'reception-bby-serena-chen.jpg' },
    { slug: 'ivy-chen', name: 'Ivy Chen', clinics: ['Vancouver'], role: 'Customer Service Supervisor', photo: 'reception-van-ivy-chen.jpg' },
    { slug: 'eunice-zhang', name: 'Eunice Zhang', clinics: ['White Rock'], role: 'Customer Service Supervisor', photo: 'reception-wr-eunice-zhang.jpg' },
