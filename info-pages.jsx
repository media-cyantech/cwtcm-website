...
const pickInfo = (key) => STRINGS[key][STRINGS.lang] || STRINGS[key].en;
...
const ContactWeChat = ({ c }) => (
  <div style={{
    ...
    <div style={{
      ...
      <img
        src={window.__resources?.r_brand_wechat_qr_png}
        alt="WeChat QR"
...
window.FirstVisitPage = FirstVisitPage;
