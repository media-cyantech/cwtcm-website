...
const COPY = {
  ...
  treatments: {
    ...
    cards: [
      { slug: "acupuncture", photo: window.__resources.r_treatments_04_acupuncture_session_jpg, name: "Acupuncture", zh: "", body: "Fine sterile needles at precisely chosen points to settle pain, sleep and stress.", meta: "50 min · from CAD $120" },
      { slug: "tui-na", photo: window.__resources.r_treatments_01_tuina_massage_jpg, name: "Tui Na", zh: "", body: "Hands-on therapy along the meridians for muscular tension, headaches and circulation.", meta: "50 min · from CAD $100" },
      { slug: "manual-bone-setting", photo: window.__resources.r_treatments_05_bone_setting_jpg, name: "Manual Bone Setting", zh: "", body: "Skilled realignment of joints and soft tissue for chronic and acute musculoskeletal pain.", meta: "50 min · from CAD $100" },
      { slug: "moxibustion", photo: window.__resources.r_treatments_02_moxibustion_jpg, name: "Moxibustion", zh: "", body: "Slow-burning mugwort warms specific points to nourish circulation and the immune system.", meta: "50 min · from CAD $100" },
      { slug: "cupping-gua-sha", photo: window.__resources.r_treatments_06_cupping_jpg, name: "Cupping & Gua Sha", zh: "", body: "Glass cups and bone tools to release tension, refresh blood flow and reset stagnant qi.", meta: "25–50 min · from CAD $50" },
      { slug: "head-therapy", photo: window.__resources.r_treatments_07_head_therapy_jpg, name: "Head & Scalp Therapy", zh: "", body: "Traditional or aromatic scalp work for tension, fatigue and the modern screen-strained head.", meta: "50 min · from CAD $75" },
      { slug: "herbal-medicine", photo: window.__resources.r_treatments_03_herbal_medicine_jpg, name: "Herbal Consultation", zh: "", body: "Custom formulas decocted on site, written by registered herbalists after pulse and tongue diagnosis.", meta: "20–30 min consult" },
      { slug: "aesthetic-acupuncture", photo: window.__resources.r_treatments_08_acupuncture_facial_jpg, name: "Aesthetic Acupuncture", zh: "", body: "Whole-system facial work — collagen response, complexion, definition — without injectables.", meta: "75 min · from CAD $200" },
    ],
  },
  conditions: {
