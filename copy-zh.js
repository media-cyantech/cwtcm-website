...
const COPY = {
  ...
  conditions: {
    ...
    h2: "用心调理那些悄然影响日常的不适。",
    cards: [
      { icon: "pain", title: "疼痛与损伤", body: "急慢性疼痛、车祸后康复。" },
      { icon: "icbc", title: "ICBC 车祸康复", body: "挥鞭伤与软组织索赔，直接结算。" },
      { icon: "sleep", title: "睡眠与压力", body: "重建神经系统的节律。" },
      { icon: "digestion", title: "消化调理", body: "腹胀、肠易激样症状与慢性不适。" },
      { icon: "womens", title: "妇科健康", body: "月经、围绝经期与产后调理。" },
      { icon: "fertility", title: "备孕与孕产", body: "从备孕到各孕期的支持。" },
      { icon: "skin", title: "皮肤与痤疮", body: "超越表面护理的整体调理。" },
      { icon: "headache", title: "头痛与偏头痛", body: "辨证诊断与预防。" },
