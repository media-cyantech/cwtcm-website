...
const COPY = {
  ...
  conditions: {
    ...
    cards: [
      ...
      { slug: "icbc-recovery", icon: "icbc", title: "ICBC 车祸康复", body: "挥鞭伤与软组织索赔，直接结算。" },
  ...
  journal: {
    ...
    cards: [
      ...
      { tag: "调理方向", title: "ICBC 与针灸：一份说人话的指南", excerpt: "若您因车祸有软组织索赔，ICBC 认可注册针灸治疗——我们为您直接结算。这里逐条说明流程、所需材料，以及为什么多数索赔比想象中简单。", read: "阅读 6 分钟" },
  ...
  zh: {
    ...
    details: {
      ...
      items: [
        ...
        { label: '可以直接结算吗？', body: '我们为 ICBC 提供直接结算；其他延伸医疗保险请向诊所确认。' },
      ],
    },
    cta: {
      headline: '准备预约？',
