...
const COPY = {
  ...
  treatments: {
    ...
    h2: "历经世代打磨的\n八项招牌疗法。",
    cards: [
      { slug: "acupuncture", photo: window.__resources.r_treatments_04_acupuncture_session_jpg, name: "针灸", zh: "", body: "以纤细无菌针具，精准取穴，安定疼痛、睡眠与压力。", meta: "50 分钟 · CAD $120 起" },
      { slug: "tui-na", photo: window.__resources.r_treatments_01_tuina_massage_jpg, name: "推拿", zh: "", body: "沿经络手法施治，缓解肌肉紧张、头痛，促进气血循环。", meta: "50 分钟 · CAD $100 起" },
      { slug: "manual-bone-setting", photo: window.__resources.r_treatments_05_bone_setting_jpg, name: "正骨", zh: "", body: "以娴熟手法调整关节与软组织，应对慢性与急性骨骼肌肉疼痛。", meta: "50 分钟 · CAD $100 起" },
      { slug: "moxibustion", photo: window.__resources.r_treatments_02_moxibustion_jpg, name: "艾灸", zh: "", body: "艾草缓燃温灸特定穴位，温养气血、扶助免疫。", meta: "50 分钟 · CAD $100 起" },
      { slug: "cupping-gua-sha", photo: window.__resources.r_treatments_06_cupping_jpg, name: "拔罐与刮痧", zh: "", body: "以玻璃罐与刮痧板舒缓紧张、活血行气、疏通瘀滞。", meta: "25–50 分钟 · CAD $50 起" },
      { slug: "head-therapy", photo: window.__resources.r_treatments_07_head_therapy_jpg, name: "头疗", zh: "", body: "传统或香薰头部手法，舒缓紧张、疲劳与久对屏幕的头部不适。", meta: "50 分钟 · CAD $75 起" },
      { slug: "herbal-medicine", photo: window.__resources.r_treatments_03_herbal_medicine_jpg, name: "中药调理", zh: "", body: "注册中医师经脉诊、舌诊后开具个性化配方，本地煎制。", meta: "20–30 分钟咨询" },
      { slug: "aesthetic-acupuncture", photo: window.__resources.r_treatments_08_acupuncture_facial_jpg, name: "美容针", zh: "", body: "整体面部美容针——激发胶原、改善气色与轮廓，无需注射。", meta: "75 分钟 · CAD $200 起" },
    ],
  },
  conditions: {
    eyebrow: "我们擅长调理",
...
const STRINGS = {
  ...
  treatments: {
    ...
    groups: [
      ...
      },
      {
        ...
        zh: 'Signature',
        cards: [
          { slug: 'floating-needle',       name: '浮针',     sub: 'Floating Needle (FSN)',    tagline: '现代、近乎无痛的肌筋膜疼痛疗法。',                    kind: 'fsn'    },
      ...
      groups: [
        ...
        { title: '注册治疗',
          ...
          items: [
            ...
            { name: '首诊中医脉诊', sub: 'Initial TCM Consultation', price: '$35/次+GST', pkg: '中药费另算' },
            { name: '后续中医脉诊', sub: 'Follow-up Consultation', price: '$35/次+GST', pkg: '同医师复诊 · 抓药免诊金' },
          ] },
      ],
  ...
  vancouver: {
    priceList: {
      eyebrow: '服务项目与价格',
      h2: '温西店服务项目一览。',
      lede: '我们致力于提供专业、综合、个性化的健康管理服务，将传统中医理论与现代康复理念相结合，为每位患者制定最适合的治疗方案。',
      items: [
        { name: '针灸', sub: 'Acupuncture', price: '$120', dur: '50分钟' },
        { name: '中医推拿', sub: 'Chinese Tuina Massage', price: '$100+税', dur: '50分钟' },
        { name: '注册按摩治疗', sub: 'Registered Massage Therapy (RMT)', price: '$130+税', dur: '50分钟' },
        { name: '中医美容', sub: 'Cosmetic Acupuncture & TCM Aesthetics', price: '$180+税', dur: '75分钟' },
        { name: '精油头疗', sub: 'Essential Oil Scalp Therapy', price: '$130+税', dur: '50分钟' },
        { name: '古法头疗', sub: 'Traditional Chinese Head Therapy', price: '$130+税', dur: '50分钟' },
        { name: '中医理筋正骨', sub: 'TCM Musculoskeletal Therapy', price: '$100+税', dur: '50分钟' },
        { name: '运动康复', sub: 'Sports Rehabilitation', price: '$100+税', dur: '50分钟' },
        { name: '产后康复', sub: 'Postpartum Rehabilitation', price: '详询门店' },
        { name: '心理咨询 · 疗愈', sub: 'Psychological Counselling & Healing', price: '$120+税', dur: '50分钟' },
        { name: '临床催眠', sub: 'Clinical Hypnotherapy', price: '$200+税', dur: '100分钟' },
        { name: '科学中药（一人一方）', sub: 'Personalized Herbal Medicine', price: '$1.2/克' },
        { name: '艾灸', sub: 'Moxibustion', price: '$100+税', dur: '50分钟' },
        { name: '扶阳透灸', sub: 'Fu Yang Moxibustion', price: '$220+税', dur: '90分钟' },
        { name: '多特瑞精油全身推拿', sub: 'doTERRA Essential Oil Massage', price: '$145+税', dur: '50分钟' },
        { name: '淋巴排毒', sub: 'Manual Lymphatic Drainage', price: '$130+税', dur: '50分钟' },
        { name: '拔罐', sub: 'Cupping', price: '$100+税', dur: '50分钟' },
        { name: '放血疗法', sub: 'Therapeutic Bloodletting', price: '$100+税', dur: '50分钟' },
        { name: '刮痧', sub: 'Gua Sha', price: '$100+税', dur: '50分钟' },
      ],
    ...
    gallery: {
      ...
      h2: '店内一览。',
      cards: [
        { photo: 'assets/locations/vancouver/gallery-vancouver-corridor-bright.jpg', alt: '治疗室走廊 · 加西中医温哥华店' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-interior-1.jpg', alt: '室内 · 加西中医温哥华店' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-interior-2.jpg', alt: '治疗空间 · 加西中医温哥华店' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-waiting-area.jpg', alt: '候诊区 · 加西中医温哥华店' },
        { photo: 'assets/locations/vancouver/gallery-vancouver-storefront-glass.jpg', alt: 'West Broadway 店面 · 加西中医温哥华店' },
      ],
    },
    find: {
      eyebrow: '这里有什么',
      ...
      practitioners: [
        ...
        },
        {
          ...
          crop: '50% 22%',
          creds: ['R.TCM.P', '中医学硕士'],
          subtitle: '南京中医药大学中医学硕士 · 近二十年康复临床',
        },
      ],
      teamCta: { label: '查看全部医师团队 →', href: 'Practitioners-ZH.html' },
...
STRINGS.burnaby.priceList = Object.assign({}, STRINGS.richmond.priceList, { h2: '本拿比店服务项目一览。' });
