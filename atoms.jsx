...
window.HeroTopScrim = HeroTopScrim;
window.Clauses = Clauses;
window.ConditionIcon = ConditionIcon;
window.TreatmentPlaceholder = TreatmentPlaceholder;
window.LocationPlaceholder = LocationPlaceholder;
window.ArticlePlaceholder = ArticlePlaceholder;
window.ApproachMacro = ApproachMacro;
