  ...
  <footer data-screen-label="12 Footer" style={{
    ...
    <div className="container">
      <div style={{
        ...
        <img src={window.__resources.r_brand_logo_tight_avif} alt="加西中医 Canadian Western TCM" style={{
      ...
      <div style={{
        ...
        <FooterColumn title={f.columns.connected}>
          ...
          <div style={{ display: 'flex', gap: 14, marginTop: 4, flexWrap: 'wrap' }}>
            {[
              { src: window.__resources.r_brand_wechat_qr_png, label: isZh ? '微信' : 'WeChat' },
              { src: window.__resources.r_brand_xiaohongshu_qr_png, label: '小红书' },
              { src: window.__resources.r_brand_instagram_qr_png, label: 'Instagram' },
            ].map((q, i) => (
